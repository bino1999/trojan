...
--
-- Host: localhost:3306
-- Generation Time: May 22, 2026 at 11:36 PM
...
INSERT INTO `accounts` (`account_id`, `slug`, `name`, `balance`, `created_at`) VALUES
(1, 'bank', 'Bank', 300.00, '2025-08-29 18:52:25'),
(2, 'credits', 'Credits', 0.00, '2025-08-29 18:52:47'),
(3, 'in_hand', 'In Hand', -41000.00, '2025-08-29 19:00:57'),
(4, 'loan', 'Loan', 100000.00, NULL),
(5, 'card_machine', 'Card Machine', 0.00, '2025-09-05 00:12:48');
...
CREATE TABLE `account_transactions` (
  ...
  `account_slug` varchar(50) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `amount` decimal(12,2) DEFAULT NULL,
  `txn_type` enum('credit','debit') DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `reference_type` varchar(50) DEFAULT NULL COMMENT 'Type of reference (quick_bill, service_job, expense, etc.)',
  `reference_id` int(11) DEFAULT NULL COMMENT 'ID of the reference record',
  `parent_txn_id` int(11) DEFAULT NULL,
  `payment_method` varchar(50) DEFAULT NULL COMMENT 'Original payment method',
  `company_name` varchar(255) DEFAULT NULL,
  `expected_return_date` date DEFAULT NULL,
  `loan_direction` enum('in','out') DEFAULT NULL,
  `customer_id` int(11) DEFAULT NULL COMMENT 'Customer ID if applicable',
  ...
  `running_balance` decimal(12,2) DEFAULT NULL COMMENT 'Running balance after this transaction',
  `returned_total` decimal(15,2) NOT NULL DEFAULT 0.00
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `account_transactions` (`txn_id`, `account_slug`, `description`, `amount`, `txn_type`, `created_at`, `reference_type`, `reference_id`, `parent_txn_id`, `payment_method`, `company_name`, `expected_return_date`, `loan_direction`, `customer_id`, `created_by`, `updated_at`, `running_balance`, `returned_total`) VALUES
(1, 'in_hand', 'Cash payment for Purchase Order #1', 20000.00, 'debit', '2026-05-22 10:55:52', 'purchase_order', 1, NULL, 'Cash', NULL, NULL, NULL, NULL, 1, '2026-05-22 10:55:52', -20000.00, 0.00),
(2, 'in_hand', 'Cash payment for Purchase Order #1', 21300.00, 'debit', '2026-05-22 10:57:19', 'purchase_order', 1, NULL, 'Cash', NULL, NULL, NULL, NULL, 1, '2026-05-22 10:57:19', -41300.00, 0.00),
(3, 'in_hand', 'Cash payment of LKR 1,500.00 for Quick Bill #1', 1500.00, 'credit', '2026-05-22 11:44:50', 'quick_bill', 1, NULL, 'Cash', NULL, NULL, NULL, 1, 1, '2026-05-22 11:44:50', -39800.00, 0.00),
(4, 'in_hand', 'Cash payment of LKR 500.00 for Quick Bill #2', 500.00, 'credit', '2026-05-22 11:55:42', 'quick_bill', 2, NULL, 'Cash', NULL, NULL, NULL, 1, 1, '2026-05-22 11:55:42', -39300.00, 0.00),
(5, 'in_hand', 'Cash payment of LKR 3,000.00 for Service Job #1', 3000.00, 'credit', '2026-05-22 12:24:20', 'service_job', 1, NULL, 'cash', NULL, NULL, NULL, NULL, 1, '2026-05-22 12:24:20', -36300.00, 0.00),
(6, 'bank', 'Bank_transfer payment of LKR 300.00 for Service Job #1 (Ref: ss22222cs) - MCB Bank Limited', 300.00, 'credit', '2026-05-22 12:25:19', 'service_job', 1, NULL, 'bank_transfer', NULL, NULL, NULL, NULL, 1, '2026-05-22 12:25:19', 300.00, 0.00),
(7, 'credits', 'Job Invoice Credit - Shashi Gunasekara - Job #1', 0.00, 'credit', '2026-05-22 12:26:26', 'service_job', 1, NULL, NULL, NULL, NULL, NULL, 1, 1, '2026-05-22 12:31:08', NULL, 0.00),
(8, 'in_hand', 'Credit payment of LKR 300.00 via Cash', 300.00, 'credit', '2026-05-22 12:31:08', 'credit_payment', 7, NULL, 'cash', NULL, NULL, NULL, 1, 1, '2026-05-22 12:31:08', -36000.00, 0.00),
(9, 'loan', '', 100000.00, 'credit', '2026-05-22 13:37:02', 'loan', NULL, NULL, 'loan', 'troja management', '2026-05-30', 'in', NULL, 1, '2026-05-22 13:37:02', 100000.00, 0.00),
(10, 'in_hand', 'Expense recorded - Voucher #100', 5000.00, 'debit', '2026-05-22 14:00:47', 'expense', 1, NULL, 'expense', NULL, NULL, NULL, NULL, 1, '2026-05-22 14:00:47', -41000.00, 0.00);
...
INSERT INTO `customers` (`customers_id`, `salutation`, `name`, `nic`, `email`, `mobile`, `mobile_2`, `address_no`, `street`, `province_id`, `district_id`, `city_id`, `postal_code`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, 'MR', 'Shashi Gunasekara', NULL, NULL, '0759848438', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-22 15:42:08', 1, NULL, NULL);
...
CREATE TABLE `employee_sections` (
  `employeeSectionId` int(10) UNSIGNED NOT NULL,
  `employeeSectionName` varchar(100) NOT NULL,
...
INSERT INTO `employee_sections` (`employeeSectionId`, `employeeSectionName`, `createdAt`, `updatedAt`, `isDeleted`) VALUES
(1, 'CASHIER', '2025-03-26 10:58:00', '2025-03-26 11:00:31', 0),
(2, 'PAINT', '2025-03-26 11:02:45', NULL, 0),
(3, 'FULL SERVICE', '2025-04-28 15:16:42', '2025-04-28 15:17:07', 0),
(4, 'MECHANIC', '2025-05-14 16:51:31', NULL, 0),
(5, 'ELECTRICION', '2025-05-14 16:51:58', NULL, 0),
(6, 'WASH', '2025-05-14 16:52:09', NULL, 0),
(7, 'INTERIOR  CUT AND POLISH', '2025-05-14 16:53:01', NULL, 0),
(8, 'STAFF', '2025-09-06 01:29:54', NULL, 0);
...
INSERT INTO `expenses` (`id`, `category_id`, `amount`, `expense_date`, `employee_id`, `member_id`, `person_name`, `person_phone`, `section_id`, `payment_method`, `reference_no`, `cheque_date`, `description`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 1, 5000.00, '2026-05-22', NULL, NULL, 'cxfcsc', '12412424', NULL, 'cash', '100', NULL, '', 1, '2026-05-22 14:00:47', '2026-05-22 14:00:47');
...
CREATE TABLE `expenses_categories` (
  `expensesCategoryId` int(10) UNSIGNED NOT NULL,
  `expensesCategoryName` varchar(100) NOT NULL,
...
INSERT INTO `expenses_categories` (`expensesCategoryId`, `expensesCategoryName`, `createdAt`, `updatedAt`, `isDeleted`) VALUES
(1, 'WATER BILL', '2025-03-26 10:25:35', '2025-03-26 10:25:48', 0),
(2, 'ELECTRICITY BILL', '2025-03-26 10:26:07', '2025-03-26 10:26:17', 0),
(3, 'TELEPHONE BILL', '2025-03-26 10:52:17', '2025-03-26 10:56:49', 0),
(4, 'OTHER EXPENCES', '2025-03-26 10:56:59', '2025-05-14 16:42:30', 0),
(5, 'LUNCH FOR WORKERS', '2025-05-14 16:42:53', NULL, 0),
(6, 'VEHICLE PARTS', '2025-05-14 16:45:55', NULL, 0),
(7, 'SALARY ADVANCE', '2025-05-14 16:46:17', NULL, 0),
(8, 'SALARY', '2025-05-14 16:46:30', NULL, 0),
(9, 'MEDICING ITEM OR BILL', '2025-05-14 16:47:05', NULL, 0),
(10, 'FUEL', '2025-05-14 16:47:15', NULL, 0),
(11, 'OFFICE STATIONARY', '2025-05-14 16:48:02', NULL, 0),
(12, 'TRANSPORT CHARGERS', '2025-05-14 16:48:15', NULL, 0),
(13, 'HARDWARE ITEM', '2025-05-14 16:48:50', NULL, 0),
(14, 'MD EXPENCES', '2025-05-14 16:49:58', NULL, 0),
(15, 'ADVERTISMENT OR BOOSTING', '2025-05-14 16:50:25', NULL, 0),
(16, 'DONATION', '2025-05-14 16:50:36', NULL, 0),
(17, 'GROUP WALFARE', '2025-05-14 16:51:01', NULL, 0);
...
(1, 'Salaries & Wages', 'Monthly employee salary payments', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(2, 'Office Rent', 'Rental expenses for office or premises', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(3, 'Utilities', 'Electricity, water, and internet bills', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(4, 'Office Supplies', 'Stationery and general office items', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(5, 'Travel & Transport', 'Employee travel reimbursements and fuel', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(6, 'Maintenance & Repairs', 'Building or equipment maintenance costs', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(7, 'Marketing & Advertising', 'Promotional and advertising expenses', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(8, 'Professional Services', 'Consultants, legal, or accounting fees', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(9, 'Insurance', 'Health, vehicle, or property insurance', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(10, 'Communication', 'Phone, email, and postal services', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(11, 'Training & Development', 'Workshops, courses, and employee training', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54'),
(12, 'Miscellaneous', 'Uncategorized or irregular expenses', 1, '2025-05-27 19:14:54', '2025-05-27 19:14:54');

-- --------------------------------------------------------

--
-- Table structure for table `internal_bills`
--
...
CREATE TABLE `internal_bills` (
  ...
  `card_or_cheque_no` varchar(100) DEFAULT NULL,
  `cheque_date` date DEFAULT NULL,
...
--
-- Table structure for table `internal_bill_items`
--

CREATE TABLE `internal_bill_items` (
  `id` int(11) NOT NULL,
  `internal_bill_id` int(11) NOT NULL,
...
CREATE TABLE `item_brands` (
  `itemBrandId` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `item_brands` (`itemBrandId`, `itemBrandName`, `createdAt`, `updatedAt`, `isDeleted`) VALUES
(1, 'TOYOTA', '2025-03-26 07:48:29', '2025-03-26 09:08:30', 0),
(2, 'SUZUKI', '2025-03-26 07:50:42', '2025-03-26 09:08:42', 0),
(3, 'SAKURA', '2025-05-14 16:30:25', NULL, 0),
(4, 'VIC', '2025-05-14 16:30:34', NULL, 0),
(5, 'SUPER', '2025-05-14 16:30:50', NULL, 0),
(6, 'NISSAN', '2025-05-14 16:31:26', NULL, 0),
(7, 'MITSUBISHI', '2025-05-14 16:32:44', '2025-05-14 16:34:01', 0),
(8, 'HONDA', '2025-05-14 16:32:52', NULL, 0),
(9, 'PREMIUM', '2025-05-14 16:33:16', NULL, 0),
(10, 'TATA', '2025-05-14 16:33:24', NULL, 0),
(11, 'MAHENDRA', '2025-05-14 16:33:37', NULL, 0),
(12, 'RENAULT', '2025-05-14 16:34:26', NULL, 0),
(13, 'LUBREX', '2025-05-14 16:34:46', NULL, 0),
(14, 'GEARON', '2025-05-14 16:35:00', NULL, 0),
(15, 'TECHTRON', '2025-05-14 16:35:14', NULL, 0),
(16, 'SUPERME', '2025-05-14 16:35:33', NULL, 0),
(17, 'AVANTGARDE', '2025-05-14 16:35:52', NULL, 0),
(18, 'LUKOIL', '2025-05-14 16:36:23', NULL, 0),
(19, 'MOBIL', '2025-05-14 16:36:35', NULL, 0),
(20, 'LOCKHEED', '2025-05-14 16:36:46', NULL, 0),
(21, 'BERNER', '2025-05-14 16:36:56', NULL, 0),
(22, 'CASTROL', '2025-05-14 16:37:08', NULL, 0),
(23, 'MOTUL', '2025-05-14 16:37:21', NULL, 0),
(24, 'CWORKS', '2025-05-29 10:35:41', NULL, 0),
(25, 'DTEC', '2025-05-29 10:35:52', NULL, 0),
(26, 'EUROL', '2025-05-29 10:36:01', NULL, 0),
(27, 'CAR WASH', '2025-05-29 10:36:30', NULL, 0),
(28, 'COOLANT', '2025-05-29 10:36:48', NULL, 0),
(29, 'ENGINE CLEANER', '2025-05-29 10:36:57', NULL, 0),
(30, 'GLASS CLEANER', '2025-05-29 10:37:05', NULL, 0),
(31, 'HIGH POWER', '2025-05-29 10:37:13', NULL, 0),
(32, 'JADE', '2025-05-29 10:37:22', NULL, 0),
(33, 'LAUGFS', '2025-05-29 10:37:31', NULL, 0),
(34, 'MAZDA', '2025-05-29 10:37:39', NULL, 0),
(35, 'MENZERNA', '2025-05-29 10:37:48', NULL, 0),
(36, 'NEO', '2025-05-29 10:37:56', NULL, 0),
(37, 'POWER X', '2025-05-29 10:38:04', NULL, 0),
(38, 'PRO TEC', '2025-05-29 10:38:22', NULL, 0),
(39, 'SMC', '2025-05-29 10:38:39', NULL, 0),
(40, 'SUPER SHINE', '2025-05-29 10:38:48', NULL, 0),
(41, 'TYER SHINE', '2025-05-29 10:38:57', NULL, 0),
(42, 'WURTH', '2025-05-29 10:39:06', NULL, 0),
(43, 'DNC', '2025-05-29 10:40:48', NULL, 0),
(44, 'OTHER', '2025-05-29 10:43:22', NULL, 0),
(45, 'CONTTAYA', '2025-05-29 10:46:49', NULL, 0);
...
INSERT INTO `item_categories` (`itemCategoryId`, `itemCategoryName`, `createdAt`, `updatedAt`, `isDeleted`) VALUES
(1, 'OIL FILTER', '2025-03-25 08:14:46', '2025-05-14 16:18:39', 0),
(2, 'FUEL FILTER', '2025-03-25 08:18:08', '2025-03-25 09:00:43', 0),
(3, 'RADIATOR CAP', '2025-03-25 08:25:08', '2025-03-25 08:59:10', 0),
(4, 'AIR FILTER', '2025-03-25 08:31:54', '2025-03-25 09:24:58', 0),
(5, 'CABIN FILTER', '2025-03-25 08:32:26', '2025-03-25 09:24:52', 0),
(6, 'WIPER BLADE', '2025-03-25 08:38:19', '2025-03-25 09:22:28', 0),
(7, 'SHAMPOO', '2025-03-25 08:38:37', '2025-03-25 09:02:16', 0),
(8, 'TRANSMISSION OIL', '2025-03-25 09:06:43', '2025-05-14 16:19:04', 0),
(9, 'IN HOUSE', '2025-03-25 09:08:15', '2025-03-25 09:23:03', 0),
(10, 'ENGINE OIL', '2025-03-25 09:24:36', '2025-03-25 09:25:03', 0),
(11, 'BREAKE FLUID', '2025-05-14 16:19:39', NULL, 0),
(12, 'MOTOR OIL', '2025-05-14 16:19:55', NULL, 0),
(13, 'COOLANT', '2025-05-14 16:20:07', NULL, 0),
(14, 'AIR FRESHENER', '2025-05-29 11:54:27', NULL, 0),
(15, 'DIFFERENTIAL OIL', '2025-05-29 11:54:35', NULL, 0),
(16, 'OIL CLEANER', '2025-05-29 11:54:45', NULL, 0),
(17, 'GEAR BOX OIL', '2025-05-29 11:54:53', NULL, 0),
(18, 'TRANSMISSION FILTERS', '2025-05-29 11:55:02', NULL, 0),
(19, 'WHEEL NUT', '2025-05-29 11:55:10', NULL, 0),
(20, 'BATTERY WATER', '2025-05-29 11:55:19', NULL, 0),
(21, 'ELECTRICAL COMPONENTS', '2025-05-29 11:55:28', NULL, 0),
(22, 'MECHANICAL COMPONENTS', '2025-05-29 11:55:36', NULL, 0),
(23, 'INTERIOR ACCESSORIES', '2025-05-29 11:56:10', NULL, 0),
(24, 'SERVICE TOOLS OR EQUIPMENT', '2025-05-29 11:56:37', NULL, 0),
(25, 'SPARE PARTS', '2025-05-29 11:56:49', NULL, 0),
(26, 'BREAKE PAD AND FLUID', '2025-05-29 12:02:56', NULL, 0);
...
CREATE TABLE `off_days` (
  ...
  `date` date NOT NULL,
  `description` varchar(255) DEFAULT NULL,
  `is_company_holiday` tinyint(1) DEFAULT 0,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `off_days` (`id`, `date`, `description`, `is_company_holiday`, `created_at`, `updated_at`) VALUES
(1, '2025-09-09', '', 1, '2025-09-06 16:34:41', '2025-09-06 16:34:41'),
(2, '2025-09-16', '', 1, '2025-09-06 16:35:34', '2025-09-06 16:35:34'),
(3, '2025-01-08', '', 1, '2025-10-29 08:15:51', '2025-10-29 08:15:51');

-- --------------------------------------------------------

--
-- Table structure for table `off_days_by_user`
--

CREATE TABLE `off_days_by_user` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `date` date NOT NULL,
  `description` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `off_days_by_user`
--

INSERT INTO `off_days_by_user` (`id`, `user_id`, `date`, `description`, `created_at`, `updated_at`) VALUES
(1, 9, '2025-01-08', '', '2025-10-29 08:13:55', '2025-10-29 08:13:55'),
(2, 9, '2025-02-11', '', '2025-10-29 08:36:24', '2025-10-29 08:36:24');

-- --------------------------------------------------------

--
-- Table structure for table `outsource_parts`
--
...
--
-- Dumping data for table `outsource_parts`
--

INSERT INTO `outsource_parts` (`id`, `service_job_id`, `item_name`, `purchased_from`, `purchased_price`, `invoice_price`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
(1, 1, 'tyre 156', 'mahaga entrpri', 1500.00, 2000.00, '2026-05-22 16:17:09', '2026-05-22 06:47:09', 1, NULL),
(2, 2, 'tyre 156', 'mahaga entrpri', 5000.00, 10.00, '2026-05-22 16:50:04', '2026-05-22 07:20:04', 1, NULL);
...
CREATE TABLE `products` (
  ...
  `inventory_type` varchar(20) NOT NULL DEFAULT 'sale'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `products` (`product_id`, `product_name`, `sku`, `barcode`, `item_brand_id`, `item_category_id`, `measurement_unit`, `sale_price`, `cost_price`, `tax_rate`, `stock_quantity`, `reorder_level`, `description`, `is_active`, `created_by`, `created_at`, `updated_at`, `is_deleted`, `inventory_type`) VALUES
(1, '0303BAU00110N OIL FILTER', 'M 0O1 Maximo', '', 11, 1, 'p', 500.00, 10.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(2, '0303BC0071N OIL FILTER', 'M.002 Bolero', '', 11, 1, 'p', 100.00, 50.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'internal'),
(3, '04152 - 37010 OIL FILTER', 'OE-117', '', 1, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(4, '04152-37010\" OIL FILTER', 'OE-117-d', '', 9, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(5, '04152-38010 OIL FILTER', 'OE-116', '', 1, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(6, '1230A045-DOUBLE OIL FILTER', 'C-306 (D)', '', 7, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(7, '1230A046-DOUBLE OIL FILTER', 'C-313 (D)', '', 7, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(8, '15208 - 65F0A OIL FILTER', 'C -224', '', 6, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(9, '15208 -65FOA OIL FILTER', 'C-224', '', 9, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(10, '15208-43G00/43GOA OIL FILTER', 'C-209/C-2221', '', 6, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(11, '15208-65F0A OIL FILTER', 'C-224', '', 6, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(12, '15208EB70D AIR FILTER', 'C-206/C-103J', '', 6, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(13, '15400 - RTA - 003 OIL FILTER', 'C- 809', '', 8, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(14, '15400-RTA-003 OIL FILTER', 'C-809', '', 9, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(15, '15600 - 41010 (D) OIL FILTER', 'C-101-d', '', 1, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(16, '16510 - 81404\' OIL FILTER', 'C- 932', '', 2, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(17, '16510 -81404\'\' OIL FILTER', 'C-932', '', 9, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(18, '17220-5RD-D08 OIL FILTER', 'A- 28013/ A-898', '', 8, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(19, '279018130101 (D -BATTA) OIL FILTER', 'C - 2103 (D Batt)', '', 10, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(20, '279018130101 (D -BATTA) OIL FILTER', 'C-2103 (D BATTA)', '', 10, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(21, '279018130106 (D-L0KKA) OIL FILTER', 'C-7976 (D-Lokka)', '', 10, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(22, '90915 - 30002 (DOUBLE OIL FILTER', 'C - 115', '', 1, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(23, '90915 - Y22E1(BLACK. N OIL FILTER', 'C -110(Black N)', '', 1, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(24, '90915 - YZZD2 OIL FILTER', 'C -111(B)', '', 1, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(25, '90915 -N2ZE1 (BLACK) OIL FILTER', 'C-110 (Black N)', '', 9, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(26, '90915-30001 D) OIL FILTER', 'C-112-d', '', 1, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(27, '90915-NZZDZ OIL FILTER', 'C-111 (B)', '', 9, 1, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(28, 'M2690115 (PREMIUM) OIL FILTER', 'C-415-d', '', 9, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(29, 'M6220900 OIL FILTER', 'FC 321', '', 7, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(30, 'MD360935/MZ690115 (MITSUBISHE) OIL FILTER', 'C-415', '', 7, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(31, 'MD360935/MZ690115 (MITSUBISHE) OIL FILTER', 'C-415', '', 7, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(32, 'C-1003 OIL FILTER', 'SC-303', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(33, 'C-1008-1 OIL FILTER', 'SC-306', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(34, 'C-101 VIC - OIL', 'C-101', '', 4, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(35, 'C-110 OIL FILTERS - VIC', 'C-110 ', '', 4, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(36, 'C-1111 OIL FILTER', 'SC-112', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(37, 'C-1112 OIL FILTER', 'SC-115', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(38, 'C-112 VIC - OIL FILTER', 'C-112', '', 4, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(39, 'C-1121 SAKURA OIL FILTER', 'SC-101', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(40, 'C-115 OIL FILTER.', 'C-115', '', 4, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(41, 'C-1317 SAKURA OIL FILTER', 'SC-607', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(42, 'C-1318 SAKURA OIL FILTER', 'SC-608', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(43, 'C-1502 OIL FILTER', 'SC-503', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(44, 'C-1504 OIL FILTER WIPER', 'SC-506', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(45, 'C-1512 SAKURA OIL FILTER', 'SC-508A', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(46, 'C-1523 SAKURAOIL FILTER', 'SC-519', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(47, 'C-1704 OIL FILTER', 'SC-411', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(48, 'C-1712 OIL FILTER', 'SC-412', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(49, 'C-1717 SAKURA OIL FILTER', 'SC-409A', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(50, 'C-1803 OIL FILTER', 'SC-209', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(51, 'C-1804 SAKURAOIL FILTER', 'SC-206', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(52, 'C-1805 OIL FILTER', 'SC-207', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(53, 'C-1806 SAKURA OIL FILTER', 'SC-205', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(54, 'C-1812-2 OIL FILTER', 'SC-226/215', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(55, 'C-206 OIL CARTRIDGE - VIC', 'C-206', '', 4, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(56, 'C-209 OIL CARTRIDGE - VIC', 'C-209', '', 4, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(57, 'C-306 OIL FILTER - VIC', 'C-306', '', 4, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(58, 'C-412 OIL FILTER - VIA', 'C-412', '', 4, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(59, 'C-5808 OIL FILTER', 'SC-311', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(60, 'C-5816 OIL FILTER', 'SC-313/310', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(61, 'C-5818 SAKURA OIL FILTER', 'SC-315', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(62, 'C-6105 SAKURA OIL FILTER', 'SC-223', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(63, 'C-85230 SAKURA OIL FILTER', 'SC-85230', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(64, 'EO-10060 SAKURA OIL FILTER', 'SO-362', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(65, 'EO-1501 SAKURAOIL FILTER', 'SO-584', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(66, 'EO-1801 OIL FILTER', 'SO-206', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(67, 'O-206 OIL FILTERS - VIC', 'O-206', '', 4, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(68, 'SC-1503 SAKURA OIL FILTER', 'SC-502', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(69, 'SC-1525 OIL FILTER', 'SC-517', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(70, 'SC-1701 SAKURA OIL FILTER', 'SC-805', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(71, 'SC-525/516 (SC-1513) OIL FILTER', 'SC-525/516', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(72, 'SC-526/518 (C-1515) OIL FILTER', 'SC-526/518', '', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(73, 'SFO-0678 SURE OIL FILTER', 'SFO-0678', '', 44, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(74, 'OIL FILTERS PREMIUM 16510-81404 (C932)', '2', '', 9, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(75, 'OIL FILTERS SUZUKI 16510-81404 (C-932)', '1', '', 2, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(76, 'OIL FILTERS TOYOTA 90915-30002(C-115)', '3', '', 1, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(77, 'TRANSMISSION OIL FILTERS', '2', '', 2, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(78, '23303 - 64010 FUEL FILTER', 'FC - 158', '', 1, 2, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(79, '23390-0L041/10 FUEL FILTER', 'FE-193', '', 1, 2, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(80, '23390-64450 FUEL FILTER', 'FC - 184', '', 1, 2, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(81, 'EF-1003 SAKURA FUEL FILTER', 'SF-337', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(82, 'EF-10050 SAKURA FUEL FILTER', 'SEF-10050', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(83, 'EF-1112 SAKURA FUAL FILTER', 'SEF-1112', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(84, 'EF-15010 SAKURA FILTER', 'SF-514', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(85, 'EF-15020 (SF-516) FUEL FILTER', 'SEF-15020', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(86, 'EF-1509 SAKURA FUEL FILTER', 'SEF-1509', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(87, 'F-1110 SAKURA FUEL FILTER', 'SF-1110', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(88, 'F-1111 FUEL FILTER ELEMENT', 'SF-1111', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(89, 'FC-1001 SAKURA FUEL FILTE', 'SFC-321', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(90, 'FC-1002 SAKURA FUEL FILTER', 'SFC-318', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(91, 'FC-1003 SAKURA FUEL FILTER', 'SFC-319', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(92, 'FC-1004 SAKURA FUEL FILTE', 'SFC-317', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(93, 'FC-1006 SAKURA FUEL FILTE', 'SFC-326', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(94, 'FC-1009 SAKURA FUEL FILTER', 'SFC-332', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(95, 'FC-1104 FUEL FILTER', 'SFC-158', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(96, 'FC-1301 SAKURA FUEL FILTE', 'SFC-607', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(97, 'FC-1803 SAKURA FUEL FILTE', 'SFC-226', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(98, 'FC-1821 SAKURA FUEL FILTER', 'SFC-208A', '', 3, 2, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(99, 'SUP-S109 SUPER PRODUCTS', 'SUP-S109', '', 5, 3, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(100, 'SUP-S311 SUPER PRODUCTS', 'SUP-S311', '', 5, 3, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(101, 'SUP-S909 SUPER PRODUCTS', 'SUP-S909', '', 5, 3, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(102, '13780-50M50 AIR FILTER', 'A - 977', '', 2, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(103, '13780-50M50 AIR FILTER', 'A-977', '', 2, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(104, '13780-53M00 AIR FILTER', 'A-14540/A-0722', '', 2, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(105, '13780-53M00 AIR FILTER', 'A-14540/A-0722', '', 2, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(106, '13780-64P00 AIR FILTER', 'A-983/ A-2908', '', 2, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(107, '13780-68 H 00 AIR FILTER', 'A-973', '', 2, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(108, '13780-74P0D - CHOCOLA AIR FILTER', 'A-985', '', 2, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(109, '13870-M53M10 (IN) AIR FILTER', 'A-13780/A-2918', '', 2, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(110, '16546-0279R AIR FILTER', 'A-2035', '', 12, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(111, '16546-V0100 AIR FILTER', 'A - 243', '', 6, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(112, '17220-5AA-A00 AIR FILTER', 'A-2806/A-8013', '', 8, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(113, '17220-5R0-008 AIR FILTER', 'A - 28013/A-898', '', 8, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(114, '17220-RBJ-000 AIR FILTER', 'A-892', '', 8, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(115, '17801-00C10 AIR FILTER', 'A-1513', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(116, '17801-21030 AIR FILTER', 'A-197', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(117, '17801-21030 AIR FILTER', 'A-197', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(118, '17801-21050 AIR FILTER', 'A-1013', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(119, '17801-21060 AIR FILTER', 'A-1031/A-21031', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(120, '17801-22020 (GREEN) AIR FILTER', 'A-1003', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(121, '17801-23030 AIR FILTER', 'A-196', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(122, '17801-30060 (GREEN) AIR FILTER', 'A-1023/ A-1514', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(123, '17801-35020 AIR FILTER', 'A-171J', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(124, '17801-37021 AIR FILTER', 'A-1027', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(125, '17801-54100 AIR FILTER', 'A-170', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(126, '17801-B2010 AIR FILTER', 'A-744', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(127, '17801-OT060 AIR FILTER', 'A-1039/ A- 1536', '', 1, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(128, 'MR404847 AIR FILTER', 'A-3017', '', 7, 4, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(129, 'MR552951 AIR FILTER', 'A-3011', '', 7, 4, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(130, 'PE7W-13-3A0 AIR FILTER', 'A-25001', '', 34, 4, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(131, '(A-978)A-14460 SAKURA AIR FILTER', 'SA-14460', '', 3, 4, 'p', 100.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(132, 'A-1128 AIR FILTER', 'SA-170', '', 3, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(133, 'AS-1825 AIR FILTER', 'SAN-212S', '', 3, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(134, 'AIR FILTERS SUZUKI 13780-50M00', '1', '', 2, 4, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(135, '01452-02650 CABIN FILTER', 'AC 1511', '', 1, 5, 'p', 100.00, 10.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(136, '80291-TFO-941/80291-T CABIN FILTER', 'AC-808', '', 8, 5, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(137, '87139-0K060 CABIN FILTER', 'AC-111', '', 1, 5, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(138, '87139-12010 CABIN FILTER', 'AC-1O1', '', 1, 5, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(139, '87139-26010- NON CAR CABIN FILTER', 'AC-109E', '', 1, 5, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(140, '87139-30040 CABIN FILTER', 'AC -1083', '', 1, 5, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(141, '95860-68H00 CABIN FILTER', 'AC-934', '', 2, 5, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(142, '95860-72M00 CABIN FILTER', 'AC-4506 / AC-938', '', 9, 5, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(143, '95860-74P00 (YELLOW) CABIN FILTER', 'AC-939', '', 2, 5, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(144, '100MM (8) WIPER BLADE', 'Rear 100MM (8)', '', 9, 6, 'p', 100.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(145, '150MM (9) WIPER BLADE', 'Rear 150MM (9)', '', 9, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(146, '1700MM (28) - TOYOTA WIPER BLADE', '700MM (28)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(147, '200MM (10) WIPER BLADE', 'Rear 200MM (10)', '', 9, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(148, '250MM (11) WIPER BLADE', 'Rear 250MM (11)', '', 9, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(149, '300MM (12) WIPER BLADE', '300MM (12)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(150, '300MM (12) WIPER BLADE', 'Rear 300MM (12)', '', 9, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(151, '325MM (13) WIPER BLADE', 'Rear 325MM (13)', '', 9, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(152, '350MM (14) WIPER BLADE', '350MM (14)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(153, '350MM (14) WIPER BLADE', 'Rear 350MM (14)', '', 9, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(154, '380MM (15) WIPER BLADE', '380MM (15)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(155, '380NM (15) WIPER BLADE', 'Rear 380NM (15)', '', 9, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(156, '400MM (16) WIPER BLADE', '400MM (16\')', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(157, '400MM (16) WIPER BLADE', '400MM (16)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(158, '400MM (16) WIPER BLADE', 'Rear 400MM (16)', '', 9, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(159, '400MM (17) WIPER BLADE', '400MM (17)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(160, '450MM (18) WIPER BLADE', '450MM (18)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(161, '475MM (19) - HYBRID WIPER BLADE', '475MM (19)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(162, '500MM (20) - HYBRID WIPER BLADE', '500MM (20)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(163, '525MM (21) - HYBRID WIPER BLADE', '525MM (21)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(164, '550MM (22) - HYBRID WIPER BLADE', '550MM (22)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(165, '600MM (24) - TOYOTA WIPER BLADE', '600MM (24)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(166, '650MM (26) - TOYOTA WIPER BLADE', '650MM (26)', '', 1, 6, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(167, 'CWORKS AERO DEFLECTOR WIPER BLADE 14\'\'(35MM)', 'D241G0029', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(168, 'CWORKS AERO DEFLECTOR WIPER BLADE 16\'\'(400MM)', 'D241G0030', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(169, 'CWORKS AERO DEFLECTOR WIPER BLADE 18\'\'(450MM)', 'D241G0031', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(170, 'CWORKS AERO DEFLECTOR WIPER BLADE 18\'\'(450MM)', 'D202G0031', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(171, 'CWORKS AERO DEFLECTOR WIPER BLADE 19\'\'(475MM)', 'D241G0032', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(172, 'CWORKS AERO DEFLECTOR WIPER BLADE 19\'\'(475MM)', 'D241G0032', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(173, 'CWORKS AERO DEFLECTOR WIPER BLADE 20\"\'(500MM)', 'D241G0033', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(174, 'CWORKS AERO DEFLECTOR WIPER BLADE 20\'\'(500MM)', 'D241G0033', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(175, 'CWORKS AERO DEFLECTOR WIPER BLADE 21\'\'(525MM)', 'D241G0034', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(176, 'CWORKS AERO DEFLECTOR WIPER BLADE 21\'\'(525MM)', 'D241G0034', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(177, 'CWORKS AERO DEFLECTOR WIPER BLADE 22\'\'(550MM)', 'D241G0035', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(178, 'CWORKS AERO DEFLECTOR WIPER BLADE 22\'\'(550MM)', 'D241G0035', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(179, 'CWORKS AERO DEFLECTOR WIPER BLADE 24\'\'(600MM)', 'D241G0036', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(180, 'CWORKS AERO DEFLECTOR WIPER BLADE 26\'\'(650MM)', 'D241G0037', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(181, 'CWORKS AERO DEFLECTOR WIPER BLADE 26\'\'(650MM)', 'D241G0037', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(182, 'CWORKS AERO DEFLECTOR WIPER BLADE 28\'\'(700MM)', 'D241G0038', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(183, 'CWORKS AERO DEFLECTOR WIPER BLADE 28\'\'(700MM)', 'D241G0038', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(184, 'CWORKS BONELESS(HYBRID)WIPER BLADE 14\'\'(350MM)', 'D202G0029', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(185, 'CWORKS BONELESS(HYBRID)WIPER BLADE 16\'\'(400MM)', 'D241G0030', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(186, 'CWORKS BONELESS(HYBRID)WIPER BLADE 16\'\'(400MM)', 'D202G0030', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(187, 'CWORKS BONELESS(HYBRID)WIPER BLADE 19\'\'(475MM)', 'D202G0032', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(188, 'CWORKS BONELESS(HYBRID)WIPER BLADE 20\'\'(500MM)', 'D202G0033', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(189, 'CWORKS BONELESS(HYBRID)WIPER BLADE 21\'\'(525MM)', 'D202G0034', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(190, 'CWORKS BONELESS(HYBRID)WIPER BLADE 22\'\'(550MM)', 'D202G0035', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(191, 'CWORKS BONELESS(HYBRID)WIPER BLADE 24\'\'(600MM)', 'D241G0036', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(192, 'CWORKS BONELESS(HYBRID)WIPER BLADE 24\'\'(600MM)', 'D202G0036', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(193, 'CWORKS BONELESS(HYBRID)WIPER BLADE 26\'\'(650MM)', 'D202G0037', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(194, 'CWORKS BONELESS(HYBRID)WIPER BLADE 28\'\'(700MM)', 'D202G0038', '', 24, 6, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(195, 'SHAMPOO', 'Shampoo (36ml)', '', 9, 7, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(196, 'AT-AW TRANSMISSION OIL', '1L-2', '', 2, 8, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(197, 'ATF/WS TRANSMISSION OIL', '4L', '', 1, 8, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(198, 'ATF-DW 1 -(1L) TRANSMISSION OIL', '1L-1', '', 8, 8, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(199, 'CVT-FE TRANSMISSION OIL', '4L-2', '', 1, 8, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(200, 'CVT-GREEN 2 TRANSMISSION OIL', '4L', '', 2, 8, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(201, 'CVT-HMMF TRANSMISSION OIL', '4L-3', '', 8, 8, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(202, 'CVT-TG TRANSMISSION OIL', '4L', '', 1, 8, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(203, 'HCF-2 TRANSMISSION OIL', '4L-4', '', 8, 8, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(204, 'AIRFLOW SENSOR CLEANER 500ML', 'P2965', '', 38, 9, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(205, 'CARBURETOR&INJECTOR CLEANER 550ML', '21-812', '', 35, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(206, 'FINAL CREAM-1L', '22029.261.00', '', 35, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(207, 'HEAVY CUT COMPOUND 1000-1L', '22984.260.00', '', 35, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(208, 'JADE BLUE SOAP', '0', '', 32, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(209, 'PREMIUM HARD WAX (250G)', '3', '', 9, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(210, 'PREMIUM HARD WAX (250G)', '4', '', 9, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(211, 'ENGIN DEGREASER NO ENTRY 650ML', '22194', '', 21, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(212, 'GEARONX 140-20L DIFFERENTIAL OIL', '10', '', 14, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(213, 'GEARONX 90-20L GEAR OIL', '22', '', 14, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(214, 'LUBREX AP3 (18KG) GREASE', '60', '', 13, 9, 'g', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(215, 'TECHTRON POWER D40+(SAE15W-40) -210L ENGINE OIL', '9131', '', 15, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(216, 'AIR FRESHENER (PREMIUM LAVENDER 4L)', 'HC00034', '', 9, 9, 'ml', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(217, 'CAR WASH (PREMIUM 10L 80)', 'CC00029', '', 9, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(218, 'ENGINE CLEANER (INDUSTRIAL 4L)', 'CC00999', '', 9, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(219, 'GLASS CLEANER (PREMIUM 4L)', 'HC00305', '', 9, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(220, 'HIGH PRESSURE (PREMIUM 10L 1 TO 10)', 'CC00230', '', 9, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(221, 'INK REMOVER (PREMIUM 500L)', 'LC00996', '', 9, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(222, 'SUPER SHINER (INDUSTRIAL 4L)', 'CC00209', '', 9, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(223, 'TYRE BLACK LIQUID (INDUSTRIAL 4L)', 'CC00251', '', 9, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(224, 'TYRE POLISH (INDUSTRIL 4L)', 'CC00206', '', 9, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(225, 'UPHOLISTERY CLEANER (INDUSTRIAL 4L)', 'CC00211', '', 9, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(226, 'DETAIL BRUSH', '0', '', 25, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(227, 'GLASS CUTTING', '0', '', 25, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(228, 'POLISHINE PAD', '0', '', 25, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(229, 'CLOTH', '0', '', 43, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(230, 'HYBRID CLEANER', '0', '', 43, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(231, 'HYBRID ENGINE CLEANER', '0', '', 43, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(232, 'UNDER COAT OIL', '0', '', 43, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(233, 'WINDSCREEN CLEANER', '0', '', 43, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(234, 'CAR WASH', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(235, 'ENGINE DREGRESER 4L', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(236, 'GLASS CLEANER 4L ', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(237, 'HIGH POWER 10L', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(238, 'JET HIGH POWER 10L', '1', '', 39, 9, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(239, 'LIQUID AIR FRESHENER LEVENDRA 4L', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(240, 'LIQUID AIR FRESHENER STRAWBERRY 4L', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(241, 'LIQUID AIR FRESHNER MANGO 4L ', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(242, 'SUPER SHINE 4L ', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(243, 'TYER SHINE 4L', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(244, 'TYRE SHINE GEL 4L ', '0', '', 39, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(245, 'BATTERY TERMINAL MAINTENANCE-150ML', '890104', '', 42, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(246, 'CLEANER ADDITIVE, INJECTION SYSTEM-300ML', '5861111303', '', 42, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(247, 'DIESEL ADDITIVE-300ML', '5861001301', '', 42, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(248, 'ENGINE CLEANER ADDITIVE-400ML', '5861310400', '', 42, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(249, 'WINDSCREEN CLEANER-32ML', '892333', '', 42, 9, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(250, 'AVANTGARDE EXTRA CH 15W-40 MINERAL-1L', 'AVE15W4001', '', 17, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(251, 'AVANTGARDE EXTRA CH 15W-40 MINERAL-5L', 'AVE15W4005', '', 17, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(252, 'AVANTGARDE ULTRA CI 15W-40 MINERAL CI 4-1L', 'AVU15W4001-d', '', 17, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(253, 'AVANTGARDE ULTRA CI 15W-40 MINERAL CI 4-5L', 'AVU15W4005-d', '', 17, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(254, 'LUKOIL LUXE ACTIPURE 10W-30 MINERAL -3L', 'LLU10W3003', '', 18, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(255, 'LUKOIL LUXE ACTIPURE 15W-40 MINERAL -1L', 'LLU15W4001', '', 18, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(256, 'SUPREME PETRA (SAE 10W-30)-3L', '9147', '', 16, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(257, 'TECHTRON POWER D40+ (1L&5L) - Promo Pack', '9126', '', 15, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(258, 'TECHTRON POWER D40+(1L& 5L)-PROMO PACK', '9126', '', 15, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(259, 'CA GTX 10W30 4LTR', 'B0065W113', '', 22, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(260, 'CA-GTX 1OW30 SLCF ILSP12', 'B0065W112', '', 22, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(261, 'CA-GTX 20W50 SLCF 4LSP4', 'B0065W324', '', 22, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(262, 'CRB MULTI PROMO PACK 1L', 'B3431613', '', 22, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(263, 'CRB MULTI PROMO PACK 5L', 'CRBMULTI-6L-PACK', '', 22, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(264, 'GTX 10W30 4X3LT', 'B3423616', '', 22, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(265, 'MOBIL (LEGAND) 5L', 'M003', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(266, 'MOBIL 1000 10-30 4L', 'M002', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(267, 'MOBIL 1000 15-40 4L', 'M001', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(268, 'MOBIL 2000 5-30 4L', 'M004', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(269, 'MOBIL LEGAND 15W-40 1L', 'M003-1L', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(270, '4000 PROTEC 10W30 (3L) (MOTUL)', '10W30 (3L)', '', 23, 10, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(271, '4000 PROTEC 10W30 (4L) (MOTUL)', '10W30 (4L)', '', 23, 10, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(272, '4000 PROTEC 15W40 (1L) (MOTUL)', '15W40 (1L)', '', 23, 10, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(273, '4000 PROTEC 15W40 (3.5L) (MOTUL)', '15W40 (3.5L)', '', 23, 10, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(274, 'EUROL EVOLENCE 0W-20 3L-BDL', 'E100128-3L', '', 26, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(275, 'MOBIL DELVAC LEGEND CH-4 15W-40 HEAVY DUTY', '0', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(276, 'MOBIL SUPER EVERYDAY PROTECTION 10W-30', '0', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(277, 'MOBIL SUPER FRICTION FIGHTER 15W-40', '0', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(278, 'MOBIL SUPER FRICTION FIGHTER 5W-30 CTN12X1L', '0', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(279, 'MOBIL SUPER FRICTION FIGHTER 5W-30 CTN12X1L', '0', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(280, 'MOBIL SUPER FRICTOIN FIGHT 10W-40', '0', '', 19, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(281, 'TECHTRON POWER D40+(SAE15W 40) PROMO', '9184', '', 33, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(282, 'GTX 10W 30', 'B3423616', '', 22, 10, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(283, '8000 PERFOMAX 0W 20 4L', 'MO 10649', '', 23, 10, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(284, 'LUKOIL BREAK FLUID DOT 3-500ML', 'DOT300500', '', 18, 11, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(285, 'LOCKHEED 250ML', 'LH001', '', 20, 11, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(286, 'LOCKHEED 500ML', 'LH002', '', 20, 11, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(287, 'TOYOTA MOTOR OIL CI-4 15W-40 1L', '08880-85746', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(288, 'TOYOTA MOTOR OIL CL-4 15W-40 5L (PROMO)', '08880-85744-PROMO', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(289, 'TOYOTA MOTOR OIL PETROL GF-6A SP 0W-20 4L', '08880-84106', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(290, 'TOYOTA MOTOR OIL SP 10W-30 1L', '08880-85776', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(291, 'TOYOTA MOTOR OIL SP 10W-30 3L', '08880-80056', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(292, 'TOYOTA MOTOR OIL SP 10W-30 4L', '08880-85775', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(293, 'TOYOTA MOTOR OIL SP 15W-40 1L', '08880-85736', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(294, 'TOYOTA MOTOR OIL SP 15W-40 4L', '08880-85735', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(295, 'TOYOTA MOTER OIL SP 10W 30', '08880-58775', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(296, 'TOYOTA MOTER OIL SP 10W 30', '08880-80056', '', 1, 12, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(297, 'RADIATOR COOLANT AND ANTI-FREEZE (50%) (B) 3.78LTR', '00200-B', '', 28, 13, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(298, 'RADIATOR COOLANT AND ANTI-FREEZE (50%) (G) 3.78LTR', '00200-G', '', 28, 13, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(299, 'RADIATOR COOLANT AND ANTI-FREEZE (50%) (P) 3.78LTR', '00200-P', '', 28, 13, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(300, 'RADIATOR COOLANT AND ANTI-FREEZE (50%) (R) 3.78LTR', '00200-R', '', 28, 13, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(301, 'AIR FRESHENER', '0', '', 32, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(302, 'AIR FRESHENER', '0', '', 43, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(303, 'AIR FRESHENER', '0', '', 36, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(304, 'AIR FRESHENER', '0', '', 36, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(305, 'AIR FRESHNER CLIP LIQUID CHERY', '4', '', 9, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(306, 'AIR FRESHNER CLIP LIQUID LINEN', '5', '', 9, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(307, 'AIR FRESHNER CLIP LIQUID NEW C', '6', '', 9, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(308, 'AIR FRESHNER CLIP LIQUID STRAW B', '7', '', 9, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(309, 'AIR FRESHNER HANGING LIQUID CHERY', '8', '', 9, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(310, 'AIR FRESHNER HANGING LIQUID NEW', '9', '', 9, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(311, 'AIR FRESHNER HANGING LIQUID PLANE', '10', '', 9, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(312, 'AIR FRESHNER HANGING LIQUID WILD', '11', '', 9, 14, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(313, 'COOL 03', '10520', '', 44, 14, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(314, 'D/FRESH AIR FRESHENER', '4', '', 44, 14, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(315, 'LUKY CUP 03', '10520', '', 44, 14, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(316, 'P/SMALL 01', '10520', '', 44, 14, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(317, 'X-BLACK AIR FRESHENER', '2', '', 44, 14, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale');
INSERT INTO `products` (`product_id`, `product_name`, `sku`, `barcode`, `item_brand_id`, `item_category_id`, `measurement_unit`, `sale_price`, `cost_price`, `tax_rate`, `stock_quantity`, `reorder_level`, `description`, `is_active`, `created_by`, `created_at`, `updated_at`, `is_deleted`, `inventory_type`) VALUES
(318, 'GEARON X 140-20L DIFFERENTIAL OIL', '10', '', 33, 15, 'ml', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(319, 'OIL SEYSTEM CLEANER 300ML', '33018', '', 37, 16, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(320, 'BP-AUTRAN DEX/MERC 1LTH12', 'B11547219', '', 22, 17, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(321, 'BP-AUTRAN DEX/MERC 4LTH4', 'B11547232', '', 22, 17, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(322, 'TRANSMAX CVT 4L', 'B3424689', '', 22, 17, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(323, 'TRANSMISSION OIL CVT-GREEN 2', '1', '', 2, 17, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(324, '24727-65RN0 TRANSMISSION FILTERS', 'SUZUKI', '', 2, 18, 'p', 100.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(325, 'TYER wheel nut', '0', '', 44, 19, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(326, 'TYER wheel nut', '0', '', 44, 19, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(327, 'Battery water', '0', '', 44, 20, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(328, '1013-H4 60/55W P43T HALOGEN', '1003', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(329, '1028-T10 12V 5W CAPLESS', '1028', '', 44, 21, 'p', 500.00, 300.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(330, '1032A-H8 12V 55W', '1033', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(331, '1034-T20 12V 21W AMBER CAPLESS TURN SIGNAL WHITE', '1042', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(332, '1034-T20 12V 21W AMBER CAPLESS TURN SIGNAL YELOW', '1039', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(333, '1040-S25 12V 21V/5W STOP&TAIL LAMP', '1052', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(334, '1041-S25 12V 21W PARKING LAMP', '1053', '', 44, 21, 'p', 100.00, 50.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(335, '1064- HORN LOACK DJ623-E6.3B FEMAIL SIDE', '1087', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(336, '1070-10A- PLUG IN FUSE 10A ST-RED ', '1105', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(337, '1070-15A PLUG IN FUSE 15A ST-BLUE', '1106', '', 44, 21, 'p', 100.00, 50.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(338, '1070-20A PLUG IN FUSE 20A ST-YELLOW', '1107', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(339, '1070-30A PLUG IN FUSE 30A ST-GREEN ', '1109', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:30:20', 0, 'sale'),
(340, '1071-15A-PLUG IN FUSE 15A MINI BLUE', '1123', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(341, '1071-20A--PLUG IN FUSE 20A MINI YELLOW', '1124', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(342, '1071-30A--PLUG IN FUSE 30A MINI', '1126', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(343, '1071-A--PLUG IN FUSE 10A MINI RED', '1122', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(344, '1072-10A PLUG IN FUSE 10A MICRO-RED ', '1127', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(345, '1072-15A PLUG IN FUSE 15A MICRO-BLUE', '1128', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(346, '1072-20A PLUG IN FUSE 20A MICRO YELLOW ', '1129', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(347, '1072-30A FUSE 30A MICRO GREEN', '1131', '', 44, 21, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(348, 'BKT008+BATTERY TERMINAL', '1000078', '', 44, 22, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(349, 'BKT008-BATTERY TERMINAL', '1000079', '', 44, 22, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(350, '1076-WIRE TIE 4.6*300', '1141', '', 44, 23, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(351, '1077A-WIRE TIE 4.6*400', '1145', '', 44, 23, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(352, 'MMC001', '1786', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(353, 'MMC011-TL 24 CLIP FRONT BUMPER', '1796', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(354, 'MMC012 TL 22', '1797', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(355, 'MMC014', '1799', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(356, 'MMC015', '1800', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(357, 'MMC017 INNERGURD CLIP', '1802', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(358, 'MMC021 BLACK-BLACK', '1806', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(359, 'MMC022', '1808', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(360, 'MMC027', '1816', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(361, 'MMC028', '1817', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(362, 'MMC038', '1827', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(363, 'MMC039', '1828', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(364, 'MMC058-25', '1852', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(365, 'MMC067-ALTO DOOR LOACK KONB', '1862', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(366, 'MMC068 BAIGE', '1000118', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(367, 'MMC075 SMALL', '1872', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(368, 'MMC076', '1873', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(369, 'MMC077-25', '1874', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(370, 'MMC120 - INNER GURD RETAINER', '1923', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(371, 'MMC172-25', '1976', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(372, 'MMC174', '1978', '', 44, 23, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(373, 'ST.LINK CONTTAYA FR TOYOTA CAMRY', '48820-47010', '', 45, 25, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(374, 'ST.LINK CONTTAYA K6A 200711.5\'\' (420-59J50)', '42420-59J00', '', 45, 25, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(375, 'ST.LINK CONTTAYA SUZUKI WAGON R MH55S SI', '42420-74P00', '', 45, 25, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(376, 'ST.LINK CONTTAYA TOYOTA PRIUS RAV4 121', '48820-42030', '', 45, 25, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(377, 'ST.LINK CONTTAYA TOYOYA VITZ NEW', '48820-52030', '', 45, 25, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(378, 'ST.LINK CONTTAYA WAGON R 11\'\'', '42420-85K00', '', 45, 25, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(379, 'ST.LINK NAILUKE TOYOTA KDH200', '48820-26050', '', 45, 25, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(380, 'AUTO PARTS/BREAK PAD', 'C112G0004', '', 44, 26, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(381, 'AUTO PARTS/BREAK PAD', 'C113G0058', '', 44, 26, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(382, 'AUTO PARTS/BREAK PAD', 'C112G0001L', '', 44, 26, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(383, 'AUTO PARTS/BREAK PAD', 'C112G0002', '', 44, 26, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(384, 'AUTO PARTS/BREAK PAD', 'C112G0006', '', 44, 26, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(385, 'AUTO PARTS/BREAK PAD', 'C112G0007', '', 44, 26, 'p', 0.00, 0.00, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:09:29', 0, 'sale'),
(386, 'AUTO PARTS/BREAK PAD', 'C112G0008', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(387, 'AUTO PARTS/BREAK PAD', 'C112G0010', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(388, 'AUTO PARTS/BREAK PAD', 'C112G0011', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(389, 'AUTO PARTS/BREAK PAD', 'C112G0014', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(390, 'AUTO PARTS/BREAK PAD', 'C112G0019', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(391, 'AUTO PARTS/BREAK PAD', 'C112G0020', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(392, 'AUTO PARTS/BREAK PAD', 'C112G0015', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(393, 'AUTO PARTS/BREAK PAD', 'C112G0017', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(394, 'AUTO PARTS/BREAK PAD', 'C112G0021L', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(395, 'AUTO PARTS/BREAK SHOES', 'C140G0065', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(396, 'AUTO PARTS/BREAK SHOES', 'C140198485', '', 44, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(397, 'B/PAD CONTTATA COROLLA NZE121,AZT240 FR', 'D2183M', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(398, 'B/PAD CONTTAYA COROLLA/AE100/AT210 FR', 'D2023', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(399, 'B/PAD CONTTAYA FR HIACE KDH200', 'D2251', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(400, 'B/PAD CONTTAYA FR PRIUS KSP90', 'D2252', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(401, 'B/PAD CONTTAYA FR SUZUKI / CARRY EVERY', 'D9028', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(402, 'B/PAD CONTTAYA NCP110/NZT260', 'D2274', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(403, 'B/PAD CONTTAYA SUZUKI/ WAGON R CHANA TRUC', 'D9026', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(404, 'B/PAD CONTTAYA WAGON R STRINGRAY', 'D9074', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(405, 'B/PAD NTN ALTO/ WAGON D9061', 'D9041', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '2025-10-10 19:03:07', 0, 'sale'),
(406, 'B/PAD NTN ALTO/MARUTI +', 'D5009 NTN', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(407, 'B/PAD P/KIN D5214M SU/MARUTI TATA BATTA', 'D9005M', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(408, 'B/PAD P/KING COROLLA 141 D2254M', 'D2254/POW', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(409, 'B/PAD P/KING SUZUKI / ALTO', 'D9027/POW', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(410, 'B/SHOE CONTTAYA RE HIACE KDH 200', 'K2378', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(411, 'B/SHOE CONTTAYA SUZUKI EVERY/DA17 LN 900', 'K9005', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(412, 'B/SHOE CONTTAYA SUZUKI WAGON R', 'K9999-10', '', 45, 26, 'p', 0.00, NULL, 0.00, NULL, 0, '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'sale'),
(413, 'Test Product', 'TEST-2554', '205424993497', 3, 1, 'p', 0.00, NULL, 0.00, NULL, 0, '', 0, 1, '2025-08-27 16:35:54', '2025-08-27 16:36:16', 0, 'sale');
...
--
-- Table structure for table `purchase_history_items`
--
...
CREATE TABLE `purchase_history_items` (
  ...
  `genuine` tinyint(1) DEFAULT 1,
  `uom` varchar(50) DEFAULT NULL,
  `inventory_type` varchar(50) DEFAULT NULL,
  `quantity` int(11) DEFAULT 0,
  `discount_percent` decimal(5,2) DEFAULT NULL,
  `discount_amount` decimal(10,2) DEFAULT 0.00,
  `company_price` decimal(10,2) DEFAULT 0.00,
  ...
  `available_stock_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `purchase_history_items`
--

INSERT INTO `purchase_history_items` (`id`, `history_id`, `po_item_id`, `po_id`, `supplier_id`, `product_id`, `brand`, `category`, `purchase_date`, `genuine`, `uom`, `inventory_type`, `quantity`, `discount_percent`, `discount_amount`, `company_price`, `sale_price`, `rack_no`, `bin_no`, `reorder_level`, `note`, `created_at`, `created_by`, `available_stock`, `available_stock_at`) VALUES
(1, 1, 1, 1, 9, 102, NULL, NULL, '2026-05-22', 1, 'p', 'sale', 10, 0.00, 0.00, 800.00, 1000.00, '', '', 3, '', '2026-05-22 14:40:31', 1, 10, '2026-05-22 10:54:30'),
(2, 1, 2, 1, 9, 137, NULL, NULL, '2026-05-22', 1, 'p', 'sale', 15, 10.00, 0.00, 2000.00, 2000.00, '', '', 2, '', '2026-05-22 14:48:23', 1, 15, '2026-05-22 10:54:30');

-- --------------------------------------------------------

--
-- Table structure for table `purchase_history_payments`
--

CREATE TABLE `purchase_history_payments` (
  `id` int(11) NOT NULL,
  `history_id` int(11) NOT NULL,
  `po_id` int(11) NOT NULL,
...
--
-- Dumping data for table `purchase_history_payments`
--

INSERT INTO `purchase_history_payments` (`id`, `history_id`, `po_id`, `payment_method`, `paid_amount`, `card_or_cheque_no`, `cheque_date`, `bank_name`, `note`, `payment_date`, `created_by`) VALUES
(1, 1, 1, 'Cash', 20000.00, NULL, NULL, NULL, NULL, '2026-05-22 01:25:52', 1),
(2, 1, 1, 'Cash', 21300.00, NULL, NULL, NULL, NULL, '2026-05-22 01:27:19', 1);

-- --------------------------------------------------------

--
-- Table structure for table `purchase_item_history`
--

CREATE TABLE `purchase_item_history` (
  `history_id` int(11) NOT NULL,
  `po_id` int(11) NOT NULL,
  `supplier_id` int(11) NOT NULL,
  `bill_no` varchar(100) NOT NULL,
  `bill_date` date NOT NULL,
  `intended_payment_method` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `purchase_item_history`
--

INSERT INTO `purchase_item_history` (`history_id`, `po_id`, `supplier_id`, `bill_no`, `bill_date`, `intended_payment_method`, `vat_type`, `vat_percent`, `description`, `total_amount`, `total_paid`, `payment_completed_at`, `moved_by`, `moved_at`) VALUES
(1, 1, 9, '1005', '2026-05-22', 4, 'vat_whole', 18, '', 41300.00, 41300.00, '2026-05-22 10:58:11', 1, '2026-05-22 10:58:11');
...
CREATE TABLE `purchase_orders` (
  ...
  `bill_no` varchar(100) NOT NULL,
  `bill_date` date NOT NULL,
  `intended_payment_method` int(11) DEFAULT NULL COMMENT '1=cash, 2=cheque, 3=card, 4=credit, 5=bank_transfer',
  `vat_type` varchar(20) DEFAULT NULL,
  `vat_percent` float DEFAULT 0,
  `description` text DEFAULT NULL,
  `total_amount` decimal(12,2) DEFAULT 0.00,
  `total_paid` decimal(12,2) DEFAULT 0.00,
  ...
  `credit_person_name` varchar(255) DEFAULT NULL COMMENT 'Name of the person/company for credit payments',
  `credit_person_phone` varchar(50) DEFAULT NULL COMMENT 'Phone number of the credit person/company',
...
INSERT INTO `purchase_orders` (`po_id`, `supplier_id`, `bill_no`, `bill_date`, `intended_payment_method`, `vat_type`, `vat_percent`, `description`, `total_amount`, `total_paid`, `payment_status`, `status`, `created_by`, `created_at`, `updated_at`, `is_deleted`, `completed_at`, `completed_by`, `credit_person_name`, `credit_person_phone`, `updated_by`) VALUES
(1, 9, '1005', '2026-05-22', 4, 'vat_whole', 18, '', 41300.00, 41300.00, 'Completed', '', 1, '2026-05-22 10:26:29', '2026-05-22 01:28:11', 0, '2026-05-22 10:54:30', 1, NULL, NULL, NULL),
(2, 7, '202508', '2026-05-22', 4, 'vat_per_item', 18, '', 1770.00, 0.00, 'Pending', 'Completed', 1, '2026-05-22 11:11:38', '2026-05-22 01:43:49', 0, '2026-05-22 11:13:49', 1, NULL, NULL, NULL),
(3, 7, '100516', '2026-05-26', 4, 'none', 0, '', 3000.00, 0.00, 'Pending', 'Completed', 1, '2026-05-22 11:15:42', '2026-05-22 01:46:17', 0, '2026-05-22 11:16:17', 1, NULL, NULL, NULL),
(4, 7, '1005154', '2026-05-28', 4, 'none', 0, '', 1250.00, 0.00, 'Pending', 'Completed', 1, '2026-05-22 11:32:12', '2026-05-22 02:02:34', 0, '2026-05-22 11:32:34', 1, NULL, NULL, NULL),
(5, 9, '0001', '2026-05-23', 4, 'none', 0, '', 0.00, 0.00, 'Pending', 'Draft', 1, '2026-05-22 14:46:15', '2026-05-22 05:16:15', 0, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `purchase_order_items` (`po_item_id`, `po_id`, `supplier_id`, `product_id`, `brand`, `category`, `purchase_date`, `genuine`, `uom`, `inventory_type`, `quantity`, `discount_percent`, `discount_amount`, `company_price`, `sale_price`, `rack_no`, `bin_no`, `reorder_level`, `note`, `created_at`, `created_by`, `available_stock`, `available_stock_at`) VALUES
(1, 1, 9, 102, NULL, NULL, '2026-05-22', 1, 'p', 'sale', 10, 0.00, 0.00, 800.00, 1000.00, '', '', 3, '', '2026-05-22 14:40:31', 1, 10, '2026-05-22 10:54:30'),
(2, 1, 9, 137, NULL, NULL, '2026-05-22', 1, 'p', 'sale', 15, 10.00, 0.00, 2000.00, 2000.00, '', '', 2, '', '2026-05-22 14:48:23', 1, 15, '2026-05-22 10:54:30'),
(3, 2, 7, 327, NULL, NULL, '2026-05-22', 1, 'p', 'sale', 10, 0.00, 0.00, 150.00, 250.00, '', '', 0, '', '2026-05-22 15:12:24', 1, 4, '2026-05-22 11:13:49'),
(4, 3, 7, 327, NULL, NULL, '2026-05-26', 1, 'p', 'sale', 15, 0.00, 0.00, 200.00, 300.00, '', '', 0, '', '2026-05-22 15:16:13', 1, 15, '2026-05-22 11:16:17'),
(5, 4, 7, 327, NULL, NULL, '2026-05-28', 1, 'p', 'sale', 5, 0.00, 0.00, 250.00, 300.00, '', '', 0, '', '2026-05-22 15:32:30', 1, 0, '2026-05-22 11:32:34'),
(6, 5, 9, 302, NULL, NULL, '2026-05-23', 1, 'p', 'sale', 10, 0.00, 0.00, 50.00, 100.00, '', '', 0, '', '2026-05-22 18:46:44', 1, 10, NULL);
...
INSERT INTO `purchase_order_payments` (`id`, `po_id`, `payment_method`, `paid_amount`, `card_or_cheque_no`, `cheque_date`, `bank_name`, `note`, `payment_date`, `created_by`) VALUES
(1, 1, 'Cash', 20000.00, NULL, NULL, NULL, NULL, '2026-05-22 01:25:52', 1),
(2, 1, 'Cash', 21300.00, NULL, NULL, NULL, NULL, '2026-05-22 01:27:19', 1);
...
CREATE TABLE `quick_bill` (
  `quick_bill_id` int(11) NOT NULL,
  ...
  `final_bill_amount` float DEFAULT NULL,
  `total_paid` float DEFAULT NULL,
  `total_balance` float DEFAULT NULL,
  `credit_person_name` varchar(255) DEFAULT NULL,
  `credit_person_phone` varchar(50) DEFAULT NULL,
...
INSERT INTO `quick_bill` (`quick_bill_id`, `customer_id`, `contact_no`, `description`, `bill_amount`, `discount_percent`, `discount_amount`, `final_bill_amount`, `total_paid`, `total_balance`, `credit_person_name`, `credit_person_phone`, `credit_due_date`, `created_at`, `created_by`, `updated_at`, `updated_by`, `confirmed_by`, `confirmed_at`) VALUES
(1, 1, NULL, '', 1200, 0, 0, 1200, 0, 1200, NULL, NULL, NULL, '2026-05-22 15:44:50', 1, '2026-05-22 11:54:11', 1, 0, NULL),
(2, 1, NULL, '', 500, 0, 0, 500, 500, 0, NULL, NULL, NULL, '2026-05-22 15:55:42', 1, NULL, NULL, 0, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `quick_bill_deletions`
--

CREATE TABLE `quick_bill_deletions` (
  `id` int(11) NOT NULL,
  `quick_bill_id` int(11) NOT NULL,
  `customer_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `quick_bill_items`
--
...
CREATE TABLE `quick_bill_items` (
  ...
  `quick_bill_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  `po_item_id` int(11) NOT NULL DEFAULT 0,
  `quantity` float NOT NULL,
  `price` decimal(10,2) NOT NULL,
  `discount_percent` decimal(10,0) DEFAULT 0,
  `discount_amount` decimal(10,2) DEFAULT 0.00,
  `total_price` decimal(10,2) GENERATED ALWAYS AS (case when `discount_percent` > 0 then (`price` - `price` * `discount_percent` / 100) * `quantity` when `discount_amount` > 0 then (`price` - `discount_amount`) * `quantity` else `price` * `quantity` end) VIRTUAL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `quick_bill_items`
--

INSERT INTO `quick_bill_items` (`id`, `quick_bill_id`, `item_id`, `po_item_id`, `quantity`, `price`, `discount_percent`, `discount_amount`, `created_at`, `updated_at`, `created_by`, `updated_by`, `confirmed_by`, `confirmed_at`, `return_quantity`, `return_by`, `return_at`) VALUES
(5, 1, 327, 5, 4, 300.00, 0, 0.00, '2026-05-22 06:23:56', '2026-05-22 15:53:56', 0, 1, 0, NULL, NULL, NULL, NULL),
(6, 2, 327, 3, 2, 250.00, 0, 0.00, '2026-05-22 15:55:42', '2026-05-22 06:25:42', 1, NULL, 0, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `quick_bill_payments`
--

CREATE TABLE `quick_bill_payments` (
  `id` int(10) UNSIGNED NOT NULL,
  `quick_bill_id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `quick_bill_payments`
--

INSERT INTO `quick_bill_payments` (`id`, `quick_bill_id`, `paid_amount`, `payment_date`, `payment_method`, `credit_date`, `card_or_cheque_no`, `cheque_date`, `bank_name`, `note`, `created_at`, `created_by`, `deleted_by`, `deleted_reason`) VALUES
(4, 1, 0, '2026-05-22 11:53:56', 'Cash', NULL, NULL, NULL, NULL, NULL, '2026-05-22 11:53:56', 1, NULL, NULL),
(5, 2, 500, '2026-05-22 11:55:42', 'Cash', NULL, NULL, NULL, NULL, NULL, '2026-05-22 11:55:42', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `quick_bill_return_items`
--

CREATE TABLE `quick_bill_return_items` (
  `id` int(11) NOT NULL,
  `return_request_id` int(11) NOT NULL,
  `quick_bill_item_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  `po_item_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `quick_bill_return_requests`
--

CREATE TABLE `quick_bill_return_requests` (
  `id` int(11) NOT NULL,
  `quick_bill_id` int(11) NOT NULL,
...
--
-- Table structure for table `services_job`
--

CREATE TABLE `services_job` (
  `job_id` int(11) NOT NULL,
  `vehicle_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `job_contact_no` varchar(12) DEFAULT NULL,
  `current_mileage` int(11) NOT NULL,
  `next_service_mileage` int(11) NOT NULL,
  `service_type` varchar(10) NOT NULL,
  `status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Pending = 0, Ongoing=1, Hold=2,Cancelled=3 , Completed = 4',
  `description` text DEFAULT NULL,
  `service_date` date DEFAULT NULL,
  `next_service_date` date DEFAULT NULL,
  `is_credit` int(11) NOT NULL DEFAULT 0,
  `credit_person` text DEFAULT NULL,
  ...
  `confirmed_by` int(11) NOT NULL DEFAULT 0,
  `confirmed_at` datetime DEFAULT NULL,
  `print_access_by` int(11) NOT NULL DEFAULT 0,
  `print_access_at` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Dumping data for table `services_job`
--

INSERT INTO `services_job` (`job_id`, `vehicle_id`, `customer_id`, `job_contact_no`, `current_mileage`, `next_service_mileage`, `service_type`, `status`, `description`, `service_date`, `next_service_date`, `is_credit`, `credit_person`, `credit_remark`, `credit_pay_date`, `job_cost`, `discount_percent`, `discount_amount`, `final_bill_amount`, `total_paid`, `total_balance`, `created_at`, `created_by`, `updated_at`, `updated_by`, `confirmed_by`, `confirmed_at`, `print_access_by`, `print_access_at`) VALUES
(1, 0, 1, '0759848438', 10000, 15000, 'N', '5', '', '2026-05-22', '0000-00-00', 1, 'Shashi Gunasekara', 'text', '2026-06-30', 4000, 10, 0, 3600, 3600, 0, '2026-05-22 15:57:22', 1, '2026-05-22 12:31:08', NULL, 1, '2026-05-22 12:22:48', 1, '2026-05-22 12:22:48'),
(2, 0, 1, '0759848438', 25000, 35000, 'E', '0', '', '2026-05-22', '0000-00-00', 0, NULL, NULL, NULL, 10000, NULL, NULL, 10000, 0, 10000, '2026-05-22 16:37:18', 1, '2026-05-22 14:09:54', 1, 0, NULL, 0, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `services_job_items`
--

CREATE TABLE `services_job_items` (
  `id` int(11) NOT NULL,
  `service_job_id` int(11) NOT NULL,
  `item_id` int(11) DEFAULT NULL,
  `po_item_id` int(11) DEFAULT NULL,
  `item_type` enum('product','service','labour','other','outsource') NOT NULL,
  ...
  `discount_percent` decimal(10,0) DEFAULT 0,
  `discount_amount` decimal(10,2) DEFAULT 0.00,
  `total_price` decimal(10,2) GENERATED ALWAYS AS (case when `discount_percent` > 0 then `price` * `quantity` - `price` * `quantity` * `discount_percent` / 100 when `discount_amount` > 0 then `price` * `quantity` - `discount_amount` else `price` * `quantity` end) VIRTUAL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `services_job_items`
--

INSERT INTO `services_job_items` (`id`, `service_job_id`, `item_id`, `po_item_id`, `item_type`, `package_id`, `description`, `quantity`, `price`, `discount_percent`, `discount_amount`, `created_at`, `updated_at`, `created_by`, `updated_by`, `confirmed_by`, `confirmed_at`) VALUES
(15, 1, 0, NULL, 'labour', NULL, 'Mechanical labour charges', 1, 300.00, 0, 0.00, '2026-05-22 16:09:40', '2026-05-22 06:51:34', 1, NULL, 1, 2026),
(14, 1, 0, NULL, 'labour', NULL, 'Labour charges', 1, 200.00, 0, 0.00, '2026-05-22 16:09:30', '2026-05-22 06:52:38', 1, NULL, 1, 2026),
(12, 1, 63, NULL, 'service', NULL, NULL, 1, 1000.00, 0, 0.00, '2026-05-22 16:07:43', '2026-05-22 06:51:32', 1, NULL, 1, 2026),
(13, 1, 327, 3, 'product', NULL, NULL, 1, 250.00, 0, 0.00, '2026-05-22 16:08:34', '2026-05-22 06:51:33', 1, NULL, 1, 2026),
(16, 1, 0, NULL, 'other', NULL, 'jack charges', 1, 250.00, 0, 0.00, '2026-05-22 16:10:10', '2026-05-22 06:51:35', 1, NULL, 1, 2026),
(17, 1, 0, NULL, 'outsource', NULL, 'tyre 156', 1, 2000.00, 0, 0.00, '2026-05-22 16:17:09', '2026-05-22 06:51:36', 1, NULL, 1, 2026),
(30, 2, 6, NULL, 'service', 1, NULL, 1, 2000.00, 0, 500.00, '2026-05-22 16:59:53', '2026-05-22 07:29:53', 1, NULL, 0, NULL),
(29, 2, 5, NULL, 'service', 1, NULL, 1, 700.00, 0, 0.00, '2026-05-22 16:59:53', '2026-05-22 07:29:53', 1, NULL, 0, NULL),
(28, 2, 4, NULL, 'service', 1, NULL, 1, 750.00, 0, 0.00, '2026-05-22 16:59:53', '2026-05-22 07:29:53', 1, NULL, 0, NULL),
(27, 2, 3, NULL, 'service', 1, NULL, 1, 750.00, 0, 0.00, '2026-05-22 16:59:53', '2026-05-22 07:29:53', 1, NULL, 0, NULL),
(25, 2, 1, NULL, 'service', 1, NULL, 1, 5300.00, 0, 0.00, '2026-05-22 16:59:53', '2026-05-22 07:29:53', 1, NULL, 0, NULL),
(26, 2, 2, NULL, 'service', 1, NULL, 1, 1000.00, 0, 0.00, '2026-05-22 16:59:53', '2026-05-22 07:29:53', 1, NULL, 0, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `services_job_payments`
--

CREATE TABLE `services_job_payments` (
  `id` int(11) NOT NULL,
  `service_job_id` int(11) NOT NULL,
  `quick_bill_id` int(11) DEFAULT NULL,
  ...
  `deleted_by` int(11) DEFAULT NULL,
  `deleted_reason` text DEFAULT NULL,
  `cheque_return_by` int(11) DEFAULT NULL,
  `cheque_return_note` text DEFAULT NULL,
  `cheque_return_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `services_job_payments`
--

INSERT INTO `services_job_payments` (`id`, `service_job_id`, `quick_bill_id`, `payment_method`, `credit_date`, `paid_amount`, `bank_name`, `cheque_number`, `cheque_date`, `payment_date`, `note`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_by`, `deleted_reason`, `cheque_return_by`, `cheque_return_note`, `cheque_return_at`) VALUES
(1, 1, NULL, 'cash', NULL, 3000.00, '', '', '0000-00-00', '2026-05-22 16:24:20', NULL, '2026-05-22 16:24:20', 1, '2026-05-22 06:54:20', NULL, NULL, NULL, NULL, NULL, NULL),
(2, 1, NULL, 'bank_transfer', NULL, 300.00, 'MCB Bank Limited', 'ss22222cs', '0000-00-00', '2026-05-22 16:25:19', NULL, '2026-05-22 16:25:19', 1, '2026-05-22 06:55:19', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 1, NULL, 'credit', NULL, 300.00, '', '', '0000-00-00', '2026-05-22 16:26:26', NULL, '2026-05-22 16:26:26', 1, '2026-05-22 06:56:26', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 1, NULL, 'cash', NULL, 300.00, '', '', '0000-00-00', '2026-05-22 16:31:08', '', '2026-05-22 07:01:08', 1, '2026-05-22 07:01:08', NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `service_items` (
  ...
  `service_category_id` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `service_items` (`id`, `section_id`, `service_category_id`, `name`, `price`, `description`, `status`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES
(1, 3, 1, 'Small Car - Full Service Package', 5300, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(2, 6, 1, 'Small Car - Wash and Vacuum  ', 1000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(3, 6, 1, 'Small Car - only Body Wash', 750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(4, 7, 1, 'Small Car - Only Vacuum', 750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(5, 6, 1, 'Small Car - Under Wash (without removing tires)', 700, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(6, 6, 1, 'Small Car - under Wash (with removing tires)', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(7, 7, 1, 'Small Car - Interior Only', 15500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(8, 7, 1, 'Small Car - cut and Plish', 17000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(9, 7, 1, 'Small Car - Interior, Cut and Polish Package', 22000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(10, 6, 1, 'Small Car - Engine Camical Wash', 1850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(11, 7, 1, 'Small Car - Under Wax', 1750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(12, 4, 1, 'Small Car - Engine Degreaser', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(13, 3, 2, 'Large Car - Full Service Package ', 6350, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(14, 6, 2, 'Large Car - Wash and Vacuum', 1000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(15, 6, 2, 'Large Car - only Body Wash', 750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(16, 7, 2, 'Large Car - Only Vacuum', 700, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(17, 6, 2, 'Large Car - Under Wash (without removing tires)', 2850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(18, 6, 2, 'Large Car - Under Wash (With removing tires)', 3500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(19, 7, 2, 'Large Car - Interior only', 17500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(20, 7, 2, 'Large Car - Cut and polish', 20000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(21, 7, 2, 'Large Car - Interior, cut and polish package', 28500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(22, 6, 2, 'Large Car - Engine Camical Wash', 1850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(23, 7, 2, 'Large Car - Under Wax', 1750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(24, 4, 2, 'Large Car - Engine Degreaser', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(25, 3, 3, 'SUV - Full services package', 7300, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(26, 6, 3, 'SUV - Wash and Vacuum', 1500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(27, 6, 3, 'SUV - only Body Wash', 1000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(28, 7, 3, 'SUV - Only Vacuum', 900, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(29, 6, 3, 'SUV - Under Wash (withaout removing tires)', 3250, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(30, 6, 3, 'SUV - Under Wash (With removing tires)', 4500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(31, 7, 3, 'SUV - Interior only', 20000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(32, 7, 3, 'SUV - Cut and polish', 23000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(33, 7, 3, 'SUV - Interior, cut and polish package', 34500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(34, 6, 3, 'SUV - Engine Camical Wash', 1850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(35, 7, 3, 'SUV - Under Wax', 1850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(36, 4, 3, 'SUV - Engine Degreaser', 2500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(37, 3, 4, 'Jeeps - Full services package ', 8200, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(38, 6, 4, 'Jeeps - Wash and Vacuum', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(39, 6, 4, 'Jeeps - only Body Wash', 1000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(40, 7, 4, 'Jeeps - Only Vacuum', 900, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(41, 6, 4, 'Jeeps - Under Wash (withaout removing tires)', 3500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(42, 6, 4, 'Jeeps - Under Wash (With removing tires)', 4850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(43, 7, 4, 'Jeeps - Interior only', 24000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(44, 7, 4, 'Jeeps - Cut and polish', 26000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(45, 7, 4, 'Jeeps - Interior, cut and polish package', 42500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(46, 6, 4, 'Jeeps - Engine Camical Wash', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(47, 7, 4, 'Jeeps - Under Wax', 1850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(48, 4, 4, 'Jeeps - Engine Degreaser', 2500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(49, 3, 5, 'Passenger - Full services package', 8850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(50, 6, 5, 'Passenger - Wash and Vacuum', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(51, 6, 5, 'Passenger - only Body Wash', 1250, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(52, 7, 5, 'Passenger - Only Vacuum', 1000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(53, 6, 5, 'Passenger - Under Wash (withaout removing tires)', 3750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(54, 6, 5, 'Passenger - Under Wash (With removing tires)', 4850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(55, 7, 5, 'Passenger - Interior only', 31500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(56, 7, 5, 'Passenger - Cut and polish', 28000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(57, 7, 5, 'Passenger - Interior, cut and polish package', 49500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(58, 6, 5, 'Passenger - Engine Camical Wash', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(59, 7, 5, 'Passenger - Under Wax', 1850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(60, 4, 5, 'Passenger - Engine Degreaser', 2500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(61, 3, 6, 'Mini Van - Full services package', 6750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(62, 6, 6, 'Mini Van - Wash and Vacuum', 1500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(63, 6, 6, 'Mini Van - only Body Wash', 1000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(64, 7, 6, 'Mini Van - Only Vacuum', 900, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(65, 6, 6, 'Mini Van - Under Wash (withaout removing tires)', 2500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(66, 6, 6, 'Mini Van - Under Wash (With removing tires)', 3250, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(67, 7, 6, 'Mini Van - Interior only', 22000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(68, 7, 6, 'Mini Van - Cut and polish', 18000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(69, 7, 6, 'Mini Van - Interior, cut and polish package', 34500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(70, 6, 6, 'Mini Van - Engine Camical Wash', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(71, 7, 6, 'Mini Van - Under Wax', 1750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(72, 4, 6, 'Mini Van - Engine Degreaser', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(73, 3, 7, 'FlatRoof Van - Full services package', 7250, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(74, 6, 7, 'FlatRoof Van - Wash and Vacuum', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(75, 6, 7, 'FlatRoof Van - only Body Wash', 1000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(76, 7, 7, 'FlatRoof Van - Only Vacuum', 900, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(77, 6, 7, 'FlatRoof Van - Under Wash (withaout removing tires)', 3000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(78, 6, 7, 'FlatRoof Van - Under Wash (With removing tires)', 3850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(79, 7, 7, 'FlatRoof Van - Interior only', 26000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(80, 7, 7, 'FlatRoof Van - Cut and polish', 22000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(81, 7, 7, 'FlatRoof Van - Interior, cut and polish package', 40000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(82, 6, 7, 'FlatRoof Van - Engine Camical Wash', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(83, 7, 7, 'FlatRoof Van - Under Wax', 1750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(84, 4, 7, 'FlatRoof Van - Engine Degreaser', 1850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(85, 3, 14, '14 1/2 Lorry - Full Service Package', 10500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(86, 6, 14, '14 1/2 Lorry - Under Wash', 5250, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(87, 6, 14, '14 1/2 Lorry - Body Wash', 3500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(88, 3, 15, '12 1/2 Lorry - Full Service Package', 9500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(89, 6, 15, '12 1/2 Lorry - Under Wash ', 4850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(90, 6, 15, '12 1/2 Lorry - Body Wash', 3000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(91, 3, 16, '10 1/2 Lorry - Full Service Package  ', 8250, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(92, 6, 16, '10 1/2 Lorry - Under Wash ', 4280, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(93, 6, 16, '10 1/2 Lorry - Body Wash  ', 2500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(94, 3, 16, 'Dimo batta lorry - Full Service package', 6850, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(95, 6, 9, 'MoterBike only Body Wash', 750, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(96, 6, 9, 'MoterBike Body Wash & Oil spray', 1000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(97, 7, 10, 'Hand Wax - Car Model', 1500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(98, 7, 10, 'Hand Wax - Jeeps & Passenger Model', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(99, 7, 11, 'Machine Wax - Car Model', 3500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(100, 7, 11, 'Machine Wax - Jeeps & Passenger Model', 4500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(101, 6, 17, 'Luxury Car Body Wash', 2000, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(102, 6, 17, 'Semi Luxury Car Body Wash', 1500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(103, 4, 12, 'Large Car Brake Fluid Bleeding', 18500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00'),
(104, 4, 12, 'SUV & Jeeps Brake Fluid Bleeding', 24500, '', 1, 1, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `service_items_category`
--

CREATE TABLE `service_items_category` (
  `sic_id` int(11) NOT NULL,
  `sci_name` varchar(222) NOT NULL,
  `isDeleted` int(11) NOT NULL DEFAULT 0
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Dumping data for table `service_items_category`
--

INSERT INTO `service_items_category` (`sic_id`, `sci_name`, `isDeleted`) VALUES
(1, 'SMALL CAR', 0),
(2, 'LARGE CAR', 0),
(3, 'SUV', 0),
(4, 'JEEPS', 0),
...
CREATE TABLE `service_packages` (
  ...
  `total_price` decimal(10,2) NOT NULL,
  `package_discount_type` varchar(20) DEFAULT 'none',
  `package_discount_value` decimal(10,2) DEFAULT 0.00,
  ...
  `discount_calculation` varchar(20) DEFAULT 'item_level'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `service_packages` (`id`, `package_name`, `total_price`, `package_discount_type`, `package_discount_value`, `availability_start`, `availability_end`, `created_by`, `created_at`, `updated_by`, `updated_at`, `active`, `discount_calculation`) VALUES
(1, '1231', 9000.00, 'percentage', 10.00, NULL, NULL, 1, '2025-09-03 01:37:02', 1, '2026-05-22 13:02:27', 1, 'item_level'),
(2, 'test', 6300.00, 'none', 0.00, NULL, NULL, 1, '2025-09-03 16:31:48', NULL, NULL, 1, 'item_level'),
(3, 'awurudu', 7750.00, 'none', 0.00, '2025-09-03', '2025-09-24', 1, '2025-09-03 19:47:50', 1, '2026-05-22 12:53:39', 1, 'item_level');
...
INSERT INTO `service_package_items` (`id`, `package_id`, `item_id`, `item_type`, `discount_type`, `discount_value`, `final_price`) VALUES
(62, 2, 1, 'service', 'none', 0, 0.00),
(63, 2, 2, 'service', 'none', 0, 0.00),
(76, 3, 1, 'service', 'none', 0, 5300.00),
(77, 3, 2, 'service', 'none', 0, 1000.00),
(78, 3, 3, 'service', 'none', 0, 750.00),
(79, 3, 5, 'service', 'none', 0, 700.00),
(86, 1, 1, 'service', 'none', 0, 5300.00),
(87, 1, 2, 'service', 'none', 0, 1000.00),
(88, 1, 3, 'service', 'none', 0, 750.00),
(89, 1, 4, 'service', 'none', 0, 750.00),
(90, 1, 5, 'service', 'none', 0, 700.00),
(91, 1, 6, 'service', 'fixed', 500, 1500.00);
...
CREATE TABLE `suppliers` (
  ...
  `salutation` enum('MR','MRS','MS','DR') NOT NULL,
...
INSERT INTO `suppliers` (`supplier_id`, `salutation`, `name`, `nic`, `email`, `mobile`, `mobile_2`, `address_no`, `street`, `province_id`, `district_id`, `city_id`, `postal_code`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, '', 'Opening Balance', '', 'trojamanagement91@gmail.com', '0759848438', '', '', '', 1, 7, 482, '11700', NULL, '2025-04-30 01:44:15', 1, '2025-05-15 13:12:05', 1),
(2, '', 'SERENDIB INTERNATIONAL (PVT) LTD', '', 'sserrendib100@yahoo.com', '0114614569', '', 'No 23/1', 'Kaolonnawa Road, kolonnawa', 1, 5, 353, '', '', '2025-05-27 12:52:54', 1, '2025-05-27 03:22:54', NULL),
(3, '', 'PREMIUM AUTO NW (PVT) LTD', '', 'sales@premiumauto.com', '0113642000', '', 'No 260', 'Udumulla, Mulleriya', 1, 5, 360, '', '', '2025-05-27 13:57:32', 1, '2025-05-27 04:27:32', NULL),
(4, '', 'PERERA ENTERPRISES & LOGISTICS (PVT) LTD', '', 'info@laugfslubricants.com', '0332214141', '', 'No 79/2/1', 'Indigollawatta, Ambagaspitiya', 1, 7, 465, '', '', '2025-05-27 18:12:20', 1, '2025-05-27 08:42:20', NULL),
(5, '', 'CASS LUBRICANTS (PVT) LTD', '', 'info@lukoil.lk', '0117681777', '', 'No 99', 'St. Michael\'s Road Colombo 03', 1, 5, 1838, '', '', '2025-05-27 18:15:18', 1, '2025-05-27 08:45:18', NULL),
(6, '', 'TOYOTA LANKA (PVT) LTD', '', '', '0112904700', '', '367/E', 'Jinasena Mawatha, Mahara, Kadawatha', 1, 7, 510, '', '', '2025-05-27 18:16:16', 1, '2025-05-27 08:46:16', NULL),
(7, '', 'AL AQMAR ENTERPRISES', '', 'wilitasales@alaqmarent.lk', '0112530739', '', '235/13', 'Awissawella Road,Orugodawatta', 1, 5, 118, '', '', '2025-05-27 18:22:31', 1, '2025-05-27 08:52:31', NULL),
(8, '', 'RICKSHOW MARKETING SERVICE', '', '', '0332280201', '', '', '', 1, 7, 551, '', '', '2025-05-27 18:23:48', 1, '2025-05-27 08:53:48', NULL),
(9, '', 'BERNER LANKA (PVT) LTD', '', 'info@berner.lk', '0374800855', '', '', 'Siyambalangamuwa, Bamunakotuwa, kurunegala', 4, 14, 1133, '', '', '2025-05-27 18:47:36', 1, '2025-05-27 09:17:36', NULL),
(10, '', 'PTI DISTRIBUTORS COMPANY (PVT) LTD', '', '', '0000000000', '', '76/4', 'Krikiththa, Weliweriya, Gampaha', 1, 7, 495, '', '', '2025-05-27 18:50:32', 1, '2025-05-27 09:20:32', NULL),
(11, '', 'RANVEL LANKA HOLDINGS (PVT) LTD', '', '', '0714526106', '', '152', 'Bekkegama Road, Walana, Panadura', 1, 10, 725, '', '', '2025-05-27 18:52:09', 1, '2025-05-27 09:22:09', NULL),
(12, '', 'SPECTRUM TRADING COMPANY (PVT) LTD', '', '', '0117607200', '', 'No 63', 'Stork Place, Colombo 10', 1, 5, 1843, '', '', '2025-05-27 18:53:17', 1, '2025-05-27 09:23:17', NULL),
(13, '', 'D TEC', '', '', '0752144031', '', '', '', 1, 7, 482, '', '', '2025-05-27 18:54:22', 1, '2025-05-27 09:24:22', NULL),
(14, '', 'BLUE EARTH (PVT) LTD', '', 'markerting@blueearth.lk', '0713929988', '', 'No 63', 'Moragasmulla Road,Rajagiriya', 1, 5, 1885, '', '', '2025-05-27 18:55:16', 1, '2025-05-27 09:25:16', NULL),
(15, '', 'DNC MARKERTING & DISTRIBUTION CO.', '', 'guncproduct@gmail.com', '00000000', '', '336/2A', 'Ihala biyanvila,Kadawatha', 1, 7, 510, '', '', '2025-05-27 18:56:18', 1, '2025-05-27 09:26:18', NULL),
(16, '', 'WURTH LANKA (PVT)LTD', '', '', '0719908873', '', '375/B', 'Highlevel Rd,Makubura', 1, 5, 364, '', '', '2025-05-27 18:56:59', 1, '2025-05-27 09:26:59', NULL),
(17, '', 'NETSCHEM LANKA HOLDING (PVT)LTD', '', 'nestchem@gmail.com', '0752126481', '', 'No188', 'Malwana Road,Samanabadda,Thiththapaththara', 1, 7, 573, '', '', '2025-05-27 18:57:49', 1, '2025-05-27 09:27:49', NULL),
(18, '', 'MIHINULA MOTERS', '', '', '0334545765', '', '261/10', 'Balummahara,Ibulgoda', 1, 7, 508, '', '', '2025-05-27 19:36:06', 1, '2025-05-27 10:06:06', NULL),
(19, '', 'TOYOTSU LANKA (PVT) LTD', '', 'info@toyotsu.lk', '0112904949', '', 'No/359', 'NEGAMBO ROAD,WATHTHALA', 1, 7, 585, '', '', '2025-05-27 19:38:25', 1, '2025-05-27 10:08:25', NULL),
(20, '', 'RANGE DISTRIBUTORS', '', '', '0717064480', '', '36 1/4 ', 'GALGODAKALE ROAD,MALAMULLA', 1, 10, 725, '', '', '2025-05-27 19:39:24', 1, '2025-05-27 10:09:24', NULL),
(21, '', 'SMC DETERGENTS', '', '', '0765611318', '', '476/3', 'Ihala biyanvila,Kadawatha', 1, 7, 510, '', '', '2025-05-27 19:40:13', 1, '2025-05-27 10:10:13', NULL),
(22, '', 'T.M.K ENTERPRISES', '', '', '0715226535', '', '388/1', 'PUGODA ROAD,DELGODA', 1, 7, 482, '', '', '2025-05-27 19:41:48', 1, '2025-05-27 10:11:48', NULL),
(23, '', 'McLARENS LUBRICANTS LTD', '', 'automotive@mclarenslubes.lk', '0114967474', '', 'NO/341', 'union place colombo 02', 1, 5, 1002, '', '', '2025-05-27 19:42:46', 1, '2025-05-27 10:12:46', NULL),
(24, '', 'W.A AUTO SUPPLY (PVT)LTD', '', 'waautosupply@gmail.com', '0332264856', '', '0258/8/1', 'IHALA YAGODA,IBULGODA', 1, 7, 495, '', '', '2025-05-27 19:45:11', 1, '2025-05-27 10:15:11', NULL),
(25, '', 'ECONSULT INTERNATIONAL (PVT) LTD', '', 'accounts@econsultint.lk', '0760959708', '', 'NO/278', 'union place 5TH floor,aaces tower,colombo 02', 1, 5, 1002, '', '', '2025-05-27 19:46:10', 1, '2025-05-27 10:16:10', NULL),
(26, '', 'UNITED MOTERS LANKA PLC.', '', '', '01122448112', '', 'NO 697,100', 'HYDE PARK CORNER,COLOMBO 02', 1, 5, 1002, '', '', '2025-05-27 19:49:13', 1, '2025-05-27 10:19:13', NULL),
(27, '', 'SSC ENTERPRICES ', '', '', '0761408681', '', '402/4', 'BIYAGAMA ROAD PATIYAGODA,KALANIYA', 1, 7, 495, '', '', '2025-05-27 19:50:02', 1, '2025-05-27 10:20:02', NULL),
(28, '', 'R.F.MARKERTING SERVICE (PVT)LTD', '', '', '705999078', '', 'NO 44', 'HIRANA, PANADURA', 1, 10, 725, '', NULL, '2025-05-27 19:50:53', 1, '2025-08-31 17:42:38', 1),
(29, '', 'PREMIUM LUBRICANTS', '', '', '000000011', '', '', 'waduwegama', 1, 7, 473, '', '', '2025-05-27 19:52:04', 1, '2025-05-27 10:22:04', NULL);
...
INSERT INTO `system_permissions` (`permission_id`, `permission_name`, `permission_key`, `description`, `category`, `created_at`, `updated_at`) VALUES
(1621, 'dashboard.view', 'dashboard.view', 'View dashboard', 'Dashboard', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1622, 'profile.view', 'profile.view', 'View own profile', 'Dashboard', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1623, 'profile.edit', 'profile.edit', 'Edit own profile', 'Dashboard', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1624, 'quickbill.view', 'quickbill.view', 'View quick bills', 'Quick Bills', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1625, 'quickbill.create', 'quickbill.create', 'Create new quick bills', 'Quick Bills', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1626, 'quickbill.edit', 'quickbill.edit', 'Edit existing quick bills', 'Quick Bills', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1627, 'quickbill.delete', 'quickbill.delete', 'Delete quick bills', 'Quick Bills', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1628, 'quickbill.list', 'quickbill.list', 'View quick bill list', 'Quick Bills', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1629, 'job.view', 'job.view', 'View all jobs', 'Jobs & Services', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1630, 'job.create', 'job.create', 'Create new jobs', 'Jobs & Services', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1631, 'job.edit', 'job.edit', 'Edit existing jobs', 'Jobs & Services', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1632, 'job.delete', 'job.delete', 'Delete jobs', 'Jobs & Services', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1633, 'job.approve', 'job.approve', 'Approve completed jobs (Manager function)', 'Jobs & Services', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1634, 'job.assign', 'job.assign', 'Assign jobs to technicians', 'Jobs & Services', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1635, 'job.progress', 'job.progress', 'Update job progress', 'Jobs & Services', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1636, 'job.complete', 'job.complete', 'Mark jobs as complete', 'Jobs & Services', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1637, 'billing.view', 'billing.view', 'View billing records', 'Billing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1638, 'billing.create', 'billing.create', 'Create billing records', 'Billing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1639, 'billing.edit', 'billing.edit', 'Edit billing records', 'Billing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1640, 'billing.delete', 'billing.delete', 'Delete billing records', 'Billing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1641, 'billing.approve', 'billing.approve', 'Approve billing', 'Billing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1642, 'purchasing.view', 'purchasing.view', 'View purchase orders', 'Purchasing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1643, 'purchasing.create', 'purchasing.create', 'Create purchase orders', 'Purchasing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1644, 'purchasing.edit', 'purchasing.edit', 'Edit purchase orders', 'Purchasing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1645, 'purchasing.delete', 'purchasing.delete', 'Delete purchase orders', 'Purchasing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1646, 'purchasing.approve', 'purchasing.approve', 'Approve purchase orders', 'Purchasing', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1647, 'product.view', 'product.view', 'View products', 'Products', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1648, 'product.create', 'product.create', 'Create products', 'Products', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1649, 'product.edit', 'product.edit', 'Edit products', 'Products', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1650, 'product.delete', 'product.delete', 'Delete products', 'Products', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1651, 'finance.view', 'finance.view', 'View financial reports', 'Financial', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1652, 'finance.create', 'finance.create', 'Create financial records', 'Financial', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1653, 'finance.edit', 'finance.edit', 'Edit financial records', 'Financial', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1654, 'finance.delete', 'finance.delete', 'Delete financial records', 'Financial', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1655, 'payments.cheque.return', 'payments.cheque.return', 'Return cheques', 'Financial', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1656, 'payments.reconcile', 'payments.reconcile', 'Payment reconciliation', 'Financial', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1657, 'serviceitem.view', 'serviceitem.view', 'View service items', 'Service Items', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1658, 'serviceitem.create', 'serviceitem.create', 'Create service items', 'Service Items', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1659, 'serviceitem.edit', 'serviceitem.edit', 'Edit service items', 'Service Items', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1660, 'serviceitem.delete', 'serviceitem.delete', 'Delete service items', 'Service Items', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1661, 'employee.view', 'employee.view', 'View employee list', 'Employees', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1662, 'employee.create', 'employee.create', 'Add new employees', 'Employees', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1663, 'employee.edit', 'employee.edit', 'Edit employee details', 'Employees', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1664, 'employee.delete', 'employee.delete', 'Delete employees', 'Employees', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1665, 'attendance.view', 'attendance.view', 'View attendance records', 'Employees', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1666, 'attendance.manage', 'attendance.manage', 'Mark/modify attendance', 'Employees', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1667, 'advance.view', 'advance.view', 'View employee advances', 'Employees', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1668, 'advance.manage', 'advance.manage', 'Manage employee advances', 'Employees', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1669, 'customer.view', 'customer.view', 'View customers', 'Customers', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1670, 'customer.create', 'customer.create', 'Create customers', 'Customers', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1671, 'customer.edit', 'customer.edit', 'Edit customers', 'Customers', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1672, 'customer.delete', 'customer.delete', 'Delete customers', 'Customers', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1673, 'vehicle.view', 'vehicle.view', 'View vehicles', 'Vehicles', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1674, 'vehicle.create', 'vehicle.create', 'Create vehicles', 'Vehicles', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1675, 'vehicle.edit', 'vehicle.edit', 'Edit vehicles', 'Vehicles', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1676, 'vehicle.delete', 'vehicle.delete', 'Delete vehicles', 'Vehicles', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1677, 'reports.view', 'reports.view', 'View all reports', 'Reports', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1678, 'reports.create', 'reports.create', 'Create reports', 'Reports', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1679, 'reports.export', 'reports.export', 'Export reports', 'Reports', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1680, 'admin.settings', 'admin.settings', 'System-wide settings', 'Administration', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1681, 'admin.users', 'admin.users', 'Manage system users', 'Administration', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1682, 'admin.roles', 'admin.roles', 'Manage roles and permissions', 'Administration', '2025-11-20 15:51:40', '2026-05-23 12:57:27'),
(1683, 'admin.backup', 'admin.backup', 'System backup', 'System Administration', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1684, 'sms.view', 'sms.view', 'View SMS logs', 'System Administration', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1685, 'sms.send', 'sms.send', 'Send SMS notifications', 'System Administration', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1686, 'notifications.view', 'notifications.view', 'View system notifications', 'System Administration', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1687, 'notifications.manage', 'notifications.manage', 'Manage notifications', 'System Administration', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1688, 'cron.view', 'cron.view', 'View cron job status', 'System Administration', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1689, 'cron.manage', 'cron.manage', 'Manage cron jobs', 'System Administration', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1690, 'stockupdate.view', 'stockupdate.view', 'View stock update logs', 'Purchasing & Inventory', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1691, 'stockupdate.manage', 'stockupdate.manage', 'Manage stock updates', 'Purchasing & Inventory', '2025-11-20 15:51:40', '2025-11-20 15:51:40'),
(1692, 'internalbill.view', 'internalbill.view', 'View internal bills', 'Internal Bills', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1693, 'internalbill.create', 'internalbill.create', 'Create internal bills', 'Internal Bills', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1694, 'internalbill.edit', 'internalbill.edit', 'Edit internal bills', 'Internal Bills', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1695, 'internalbill.delete', 'internalbill.delete', 'Delete internal bills', 'Internal Bills', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1696, 'internalbill.list', 'internalbill.list', 'View internal bill list', 'Internal Bills', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1697, 'job.hold', 'job.hold', 'Put jobs on hold', 'Jobs & Services', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1698, 'job.cancel', 'job.cancel', 'Cancel jobs', 'Jobs & Services', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1699, 'job.invoice', 'job.invoice', 'Generate job invoices', 'Jobs & Services', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1700, 'supplier.view', 'supplier.view', 'View suppliers', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1701, 'supplier.create', 'supplier.create', 'Add new suppliers', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1702, 'supplier.edit', 'supplier.edit', 'Edit suppliers', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1703, 'supplier.delete', 'supplier.delete', 'Delete suppliers', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1704, 'purchase.view', 'purchase.view', 'View purchase orders', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1705, 'purchase.create', 'purchase.create', 'Create purchase orders', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1706, 'purchase.edit', 'purchase.edit', 'Edit purchase orders', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1707, 'purchase.delete', 'purchase.delete', 'Delete purchase orders', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1708, 'stock.view', 'stock.view', 'View stock levels', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1709, 'stock.manage', 'stock.manage', 'Manage stock (add/remove items)', 'Purchasing', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1710, 'products.view', 'products.view', 'View products', 'Products', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1711, 'products.create', 'products.create', 'Add new products', 'Products', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1712, 'products.edit', 'products.edit', 'Edit products', 'Products', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1713, 'products.delete', 'products.delete', 'Delete products', 'Products', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1714, 'payments.view', 'payments.view', 'View payments', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1715, 'payments.create', 'payments.create', 'Record payments', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1716, 'payments.edit', 'payments.edit', 'Edit payments', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1717, 'payments.delete', 'payments.delete', 'Delete payments', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1718, 'accounts.inhand', 'accounts.inhand', 'Manage in-hand cash', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1719, 'accounts.bank', 'accounts.bank', 'Manage bank accounts', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1720, 'accounts.banktransfer', 'accounts.banktransfer', 'Bank transfers', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1721, 'accounts.cardmachine', 'accounts.cardmachine', 'Card machine transactions', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1722, 'accounts.credits', 'accounts.credits', 'Manage credits', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1723, 'accounts.loans', 'accounts.loans', 'Manage loans', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1724, 'expenses.view', 'expenses.view', 'View expenses', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1725, 'expenses.create', 'expenses.create', 'Add expenses', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1726, 'expenses.edit', 'expenses.edit', 'Edit expenses', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1727, 'expenses.delete', 'expenses.delete', 'Delete expenses', 'Finance', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1728, 'serviceitems.view', 'serviceitems.view', 'View service items', 'Service Packages', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1729, 'serviceitems.create', 'serviceitems.create', 'Add service items', 'Service Packages', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1730, 'serviceitems.edit', 'serviceitems.edit', 'Edit service items', 'Service Packages', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1731, 'serviceitems.delete', 'serviceitems.delete', 'Delete service items', 'Service Packages', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1732, 'servicepackages.view', 'servicepackages.view', 'View service packages', 'Service Packages', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1733, 'servicepackages.create', 'servicepackages.create', 'Create service packages', 'Service Packages', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1734, 'servicepackages.edit', 'servicepackages.edit', 'Edit service packages', 'Service Packages', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1735, 'servicepackages.delete', 'servicepackages.delete', 'Delete service packages', 'Service Packages', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1736, 'employee.attendance', 'employee.attendance', 'Manage attendance', 'Employees', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1737, 'employee.advance', 'employee.advance', 'Manage employee advances', 'Employees', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1738, 'settings.categories', 'settings.categories', 'Manage item categories', 'Settings', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1739, 'settings.servicecategories', 'settings.servicecategories', 'Manage service item categories', 'Settings', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1740, 'settings.brands', 'settings.brands', 'Manage item brands', 'Settings', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1741, 'settings.vehiclecategories', 'settings.vehiclecategories', 'Manage vehicle categories', 'Settings', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1742, 'settings.vehiclebrands', 'settings.vehiclebrands', 'Manage vehicle brands', 'Settings', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1743, 'settings.expensecategories', 'settings.expensecategories', 'Manage expense categories', 'Settings', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1744, 'settings.employeesections', 'settings.employeesections', 'Manage employee sections', 'Settings', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1745, 'settings.roles', 'settings.roles', 'Manage system roles and permissions', 'Settings', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1746, 'customers.view', 'customers.view', 'View customers', 'CRM', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1747, 'customers.create', 'customers.create', 'Add new customers', 'CRM', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1748, 'customers.edit', 'customers.edit', 'Edit customer details', 'CRM', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1749, 'customers.delete', 'customers.delete', 'Delete customers', 'CRM', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1750, 'vehicles.view', 'vehicles.view', 'View vehicles', 'CRM', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1751, 'vehicles.create', 'vehicles.create', 'Add new vehicles', 'CRM', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1752, 'vehicles.edit', 'vehicles.edit', 'Edit vehicle details', 'CRM', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1753, 'vehicles.delete', 'vehicles.delete', 'Delete vehicles', 'CRM', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1754, 'reports.financial', 'reports.financial', 'View financial reports', 'Reports', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1755, 'reports.jobs', 'reports.jobs', 'View job reports', 'Reports', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1756, 'reports.inventory', 'reports.inventory', 'View inventory reports', 'Reports', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1757, 'admin.logs', 'admin.logs', 'View system logs', 'Administration', '2025-11-20 15:54:58', '2026-05-23 12:57:27'),
(1758, 'accounts.cheque', 'accounts.cheque', 'Manage cheque deposits', 'Finance', '2025-11-20 16:24:47', '2026-05-23 12:57:27');
...
CREATE TABLE `system_roles` (
  ...
  `system_role_name` varchar(155) NOT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
INSERT INTO `system_roles` (`system_role_id`, `system_role_name`, `created_at`, `updated_at`, `is_deleted`) VALUES
(1, 'ADMIN', '2025-03-27 01:56:12', '2025-03-27 06:21:20', 0),
(10, 'TEST', '2025-11-20 18:47:57', '2025-11-20 18:47:57', 0);
...
INSERT INTO `system_role_permissions` (`id`, `role_id`, `permission_id`, `assigned_at`) VALUES
(1048, 1, 1621, '2025-11-20 15:51:40'),
(1049, 1, 1622, '2025-11-20 15:51:40'),
(1050, 1, 1623, '2025-11-20 15:51:40'),
(1051, 1, 1624, '2025-11-20 15:51:40'),
(1052, 1, 1625, '2025-11-20 15:51:40'),
(1053, 1, 1626, '2025-11-20 15:51:40'),
(1054, 1, 1627, '2025-11-20 15:51:40'),
(1055, 1, 1628, '2025-11-20 15:51:40'),
(1056, 1, 1629, '2025-11-20 15:51:40'),
(1057, 1, 1630, '2025-11-20 15:51:40'),
(1058, 1, 1631, '2025-11-20 15:51:40'),
(1059, 1, 1632, '2025-11-20 15:51:40'),
(1060, 1, 1633, '2025-11-20 15:51:40'),
(1061, 1, 1634, '2025-11-20 15:51:40'),
(1062, 1, 1635, '2025-11-20 15:51:40'),
(1063, 1, 1636, '2025-11-20 15:51:40'),
(1064, 1, 1637, '2025-11-20 15:51:40'),
(1065, 1, 1638, '2025-11-20 15:51:40'),
(1066, 1, 1639, '2025-11-20 15:51:40'),
(1067, 1, 1640, '2025-11-20 15:51:40'),
(1068, 1, 1641, '2025-11-20 15:51:40'),
(1069, 1, 1642, '2025-11-20 15:51:40'),
(1070, 1, 1643, '2025-11-20 15:51:40'),
(1071, 1, 1644, '2025-11-20 15:51:40'),
(1072, 1, 1645, '2025-11-20 15:51:40'),
(1073, 1, 1646, '2025-11-20 15:51:40'),
(1074, 1, 1647, '2025-11-20 15:51:40'),
(1075, 1, 1648, '2025-11-20 15:51:40'),
(1076, 1, 1649, '2025-11-20 15:51:40'),
(1077, 1, 1650, '2025-11-20 15:51:40'),
(1078, 1, 1651, '2025-11-20 15:51:40'),
(1079, 1, 1652, '2025-11-20 15:51:40'),
(1080, 1, 1653, '2025-11-20 15:51:40'),
(1081, 1, 1654, '2025-11-20 15:51:40'),
(1082, 1, 1655, '2025-11-20 15:51:40'),
(1083, 1, 1656, '2025-11-20 15:51:40'),
(1084, 1, 1657, '2025-11-20 15:51:40'),
(1085, 1, 1658, '2025-11-20 15:51:40'),
(1086, 1, 1659, '2025-11-20 15:51:40'),
(1087, 1, 1660, '2025-11-20 15:51:40'),
(1088, 1, 1661, '2025-11-20 15:51:40'),
(1089, 1, 1662, '2025-11-20 15:51:40'),
(1090, 1, 1663, '2025-11-20 15:51:40'),
(1091, 1, 1664, '2025-11-20 15:51:40'),
(1092, 1, 1665, '2025-11-20 15:51:40'),
(1093, 1, 1666, '2025-11-20 15:51:40'),
(1094, 1, 1667, '2025-11-20 15:51:40'),
(1095, 1, 1668, '2025-11-20 15:51:40'),
(1096, 1, 1669, '2025-11-20 15:51:40'),
(1097, 1, 1670, '2025-11-20 15:51:40'),
(1098, 1, 1671, '2025-11-20 15:51:40'),
(1099, 1, 1672, '2025-11-20 15:51:40'),
(1100, 1, 1673, '2025-11-20 15:51:40'),
(1101, 1, 1674, '2025-11-20 15:51:40'),
(1102, 1, 1675, '2025-11-20 15:51:40'),
(1103, 1, 1676, '2025-11-20 15:51:40'),
(1104, 1, 1677, '2025-11-20 15:51:40'),
(1105, 1, 1678, '2025-11-20 15:51:40'),
(1106, 1, 1679, '2025-11-20 15:51:40'),
(1107, 1, 1680, '2025-11-20 15:51:40'),
(1108, 1, 1681, '2025-11-20 15:51:40'),
(1109, 1, 1682, '2025-11-20 15:51:40'),
(1110, 1, 1683, '2025-11-20 15:51:40'),
(1111, 1, 1684, '2025-11-20 15:51:40'),
(1112, 1, 1685, '2025-11-20 15:51:40'),
(1113, 1, 1686, '2025-11-20 15:51:40'),
(1114, 1, 1687, '2025-11-20 15:51:40'),
(1115, 1, 1688, '2025-11-20 15:51:40'),
(1116, 1, 1689, '2025-11-20 15:51:40'),
(1117, 1, 1690, '2025-11-20 15:51:40'),
(1118, 1, 1691, '2025-11-20 15:51:40'),
(1119, 1, 1692, '2025-11-20 15:54:58'),
(1120, 1, 1693, '2025-11-20 15:54:58'),
(1121, 1, 1694, '2025-11-20 15:54:58'),
(1122, 1, 1695, '2025-11-20 15:54:58'),
(1123, 1, 1696, '2025-11-20 15:54:58'),
(1124, 1, 1697, '2025-11-20 15:54:58'),
(1125, 1, 1698, '2025-11-20 15:54:58'),
(1126, 1, 1699, '2025-11-20 15:54:58'),
(1127, 1, 1700, '2025-11-20 15:54:58'),
(1128, 1, 1701, '2025-11-20 15:54:58'),
(1129, 1, 1702, '2025-11-20 15:54:58'),
(1130, 1, 1703, '2025-11-20 15:54:58'),
(1131, 1, 1704, '2025-11-20 15:54:58'),
(1132, 1, 1705, '2025-11-20 15:54:58'),
(1133, 1, 1706, '2025-11-20 15:54:58'),
(1134, 1, 1707, '2025-11-20 15:54:58'),
(1135, 1, 1708, '2025-11-20 15:54:58'),
(1136, 1, 1709, '2025-11-20 15:54:58'),
(1137, 1, 1710, '2025-11-20 15:54:58'),
(1138, 1, 1711, '2025-11-20 15:54:58'),
(1139, 1, 1712, '2025-11-20 15:54:58'),
(1140, 1, 1713, '2025-11-20 15:54:58'),
(1141, 1, 1714, '2025-11-20 15:54:58'),
(1142, 1, 1715, '2025-11-20 15:54:58'),
(1143, 1, 1716, '2025-11-20 15:54:58'),
(1144, 1, 1717, '2025-11-20 15:54:58'),
(1145, 1, 1718, '2025-11-20 15:54:58'),
(1146, 1, 1719, '2025-11-20 15:54:58'),
(1147, 1, 1720, '2025-11-20 15:54:58'),
(1148, 1, 1721, '2025-11-20 15:54:58'),
(1149, 1, 1722, '2025-11-20 15:54:58'),
(1150, 1, 1723, '2025-11-20 15:54:58'),
(1151, 1, 1724, '2025-11-20 15:54:58'),
(1152, 1, 1725, '2025-11-20 15:54:58'),
(1153, 1, 1726, '2025-11-20 15:54:58'),
(1154, 1, 1727, '2025-11-20 15:54:58'),
(1155, 1, 1728, '2025-11-20 15:54:58'),
(1156, 1, 1729, '2025-11-20 15:54:58'),
(1157, 1, 1730, '2025-11-20 15:54:58'),
(1158, 1, 1731, '2025-11-20 15:54:58'),
(1159, 1, 1732, '2025-11-20 15:54:58'),
(1160, 1, 1733, '2025-11-20 15:54:58'),
(1161, 1, 1734, '2025-11-20 15:54:58'),
(1162, 1, 1735, '2025-11-20 15:54:58'),
(1163, 1, 1736, '2025-11-20 15:54:58'),
(1164, 1, 1737, '2025-11-20 15:54:58'),
(1165, 1, 1738, '2025-11-20 15:54:58'),
(1166, 1, 1739, '2025-11-20 15:54:58'),
(1167, 1, 1740, '2025-11-20 15:54:58'),
(1168, 1, 1741, '2025-11-20 15:54:58'),
(1169, 1, 1742, '2025-11-20 15:54:58'),
(1170, 1, 1743, '2025-11-20 15:54:58'),
(1171, 1, 1744, '2025-11-20 15:54:58'),
(1172, 1, 1745, '2025-11-20 15:54:58'),
(1173, 1, 1746, '2025-11-20 15:54:58'),
(1174, 1, 1747, '2025-11-20 15:54:58'),
(1175, 1, 1748, '2025-11-20 15:54:58'),
(1176, 1, 1749, '2025-11-20 15:54:58'),
(1177, 1, 1750, '2025-11-20 15:54:58'),
(1178, 1, 1751, '2025-11-20 15:54:58'),
(1179, 1, 1752, '2025-11-20 15:54:58'),
(1180, 1, 1753, '2025-11-20 15:54:58'),
(1181, 1, 1754, '2025-11-20 15:54:58'),
(1182, 1, 1755, '2025-11-20 15:54:58'),
(1183, 1, 1756, '2025-11-20 15:54:58'),
(1184, 1, 1757, '2025-11-20 15:54:58'),
(1322, 10, 1623, '2025-11-20 18:48:05'),
(1321, 10, 1622, '2025-11-20 18:48:05'),
(1320, 10, 1621, '2025-11-20 18:48:05'),
(1199, 1, 1758, '2025-11-20 16:24:47');
...
CREATE TABLE `users` (
  ...
  `CreatedAt` datetime NOT NULL,
  `UpdatedAt` datetime DEFAULT NULL,
  `password_changed` tinyint(1) DEFAULT 0 COMMENT '0=default password, 1=user changed password',
  `first_login_date` datetime DEFAULT NULL COMMENT 'Date of first successful login',
  `last_password_change` datetime DEFAULT NULL COMMENT 'Date of last password change',
  `last_login_date` datetime DEFAULT NULL COMMENT 'Date of last login'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`UserID`, `UserName`, `FirstName`, `LastName`, `Email`, `PhoneNumber`, `Password`, `Role`, `EmployeeID`, `Department`, `HireDate`, `IsActive`, `salary`, `CreatedAt`, `UpdatedAt`, `password_changed`, `first_login_date`, `last_password_change`, `last_login_date`) VALUES
(1, 'Admin', 'Troja', 'Autohub', 'troaautohub@gmail.com', '0759848438', 'VTAENFNg', 1, '0', 8, '2025-03-25', 1, NULL, '2025-03-25 06:16:28', '2025-09-06 01:30:24', 1, '2025-09-06 01:23:48', '2025-09-06 01:11:18', '2026-05-23 00:24:34'),
(9, 'Dayvez', 'Navindra', 'Niyomal', 'navindraniyomal@gmail.com', '0719528954', 'UzZWZVBiWzNQNVQ3', 10, '69', 8, '2025-09-06', 1, 50000.00, '2025-09-06 01:13:30', '2025-11-21 00:18:15', 1, '2025-09-06 01:14:03', '2025-11-19 22:53:43', '2025-11-21 00:18:26'),
(10, 'Test', 'test', '123', '1231@gmail.com', '1415616', 'UzYBMVJhWjEDZwJh', 4, '111', 1, '2025-09-06', 1, 30000.00, '2025-09-06 01:25:50', '2025-11-19 21:43:55', 1, '2025-09-06 01:28:14', '2025-11-19 21:44:49', '2025-11-19 22:40:29'),
(11, 'Shashi', 'Shashi', 'Gunasekara', 'Testuseraccount@gmail.com', '0759848438', 'AmUKOgQ1WjFQNFEy', 1, '69', 8, '2025-09-18', 1, 50000.00, '2025-09-18 00:53:31', '2025-09-23 22:20:40', 1, '2025-09-18 00:54:02', '2025-09-23 22:21:33', '2025-09-23 22:20:55');
...
INSERT INTO `user_logs` (`log_id`, `user_id`, `action`, `description`, `created_at`, `ip_address`, `user_agent`) VALUES
(1, 1, 'Login', 'Loged In', '2026-01-23 00:31:04', '111.223.184.109', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36'),
(2, 1, 'Login', 'Loged In', '2026-02-24 00:51:51', '175.157.26.42', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36'),
(3, 1, 'Login', 'Loged In', '2026-02-28 22:20:53', '124.43.226.87', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36'),
(4, 1, 'Login', 'Loged In', '2026-03-14 14:32:49', '112.135.209.142', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36'),
(5, 1, 'Login', 'Loged In', '2026-03-26 16:13:21', '112.135.169.99', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36'),
(6, 1, 'Login', 'Loged In', '2026-05-21 14:49:51', '112.135.217.126', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(7, 1, 'Login', 'Loged In', '2026-05-22 14:13:23', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(8, 1, 'Inventory Item Added', 'Product ID: 102', '2026-05-22 14:40:31', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(9, 1, 'Inventory Item Added', 'Product ID: 137', '2026-05-22 14:48:23', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(10, 1, 'Inventory Item Added', 'Product ID: 327', '2026-05-22 15:12:24', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(11, 1, 'Inventory Item Added', 'Product ID: 327', '2026-05-22 15:16:13', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(12, 1, 'Inventory Item Added', 'Product ID: 327', '2026-05-22 15:32:30', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(13, 1, 'Job status updated', 'Job ID: 1, Status: 1', '2026-05-22 16:18:20', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(14, 1, 'Job status updated', 'Job ID: 1, Status: 4', '2026-05-22 16:19:53', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(15, 1, 'Job status updated', 'Job ID: 1, Status: 1', '2026-05-22 16:21:20', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(16, 1, 'Job status updated', 'Job ID: 1, Status: 4', '2026-05-22 16:21:27', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(17, 1, 'Discount added to job', 'Job ID: 1, Discount Rate: 10, Discount Amount: 0', '2026-05-22 16:21:44', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(18, 1, 'Job confirmed', 'Job ID: 1', '2026-05-22 16:22:48', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(19, 1, 'Inventory Item Added', 'Product ID: 302', '2026-05-22 18:46:44', '112.135.220.80', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(20, 1, 'Login', 'Loged In', '2026-05-22 23:32:43', '175.157.21.126', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(21, 1, 'Login', 'Loged In', '2026-05-23 01:18:07', '175.157.187.195', 'Mozilla/5.0 (iPhone; CPU iPhone OS 26_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/148.0.7778.100 Mobile/15E148 Safari/604.1'),
(22, 1, 'Login', 'Loged In', '2026-05-23 03:06:13', '175.157.21.126', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36'),
(23, 1, 'Login', 'Loged In', '2026-05-23 04:24:34', '175.157.76.72', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Mobile Safari/537.36');
...
CREATE TABLE `vehicle_brands` (
  `vehicleBrandId` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `vehicle_brands` (`vehicleBrandId`, `vehicleBrandName`, `createdAt`, `updatedAt`, `isDeleted`) VALUES
(1, 'TOYOTA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(2, 'SUZUKI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(3, 'HONDA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(4, 'NISSAN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(5, 'MITSUBISHI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(6, 'TATA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(7, 'BAJAJ', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(8, 'TVS', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(9, 'ISUZU', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(10, 'MAHINDRA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(11, 'MAZDA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(12, 'HERO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(13, 'MICRO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(14, 'DAIHATSU', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(15, 'HYUNDAI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(16, 'HERO-HONDA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(17, 'DFSK', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(18, 'MERCEDES-BENZ', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(19, 'KIA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(20, 'FORD', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(21, 'PERODUA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(22, 'RENAULT', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(23, 'PEUGEOT', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(24, 'BMW', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(25, 'YAMAHA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(26, 'ACURA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(27, 'ALFA-ROMEO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(28, 'APRILIA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(29, 'ASHOK-LEYLAND', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(30, 'ASTON', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(31, 'ATCO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(32, 'AUDI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(33, 'AUSTIN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(34, 'BENTLEY', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(35, 'BORGWARD', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(36, 'BYD', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(37, 'CADILLAC', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(38, 'CEYGRA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(39, 'CHANGAN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(40, 'CHERY', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(41, 'CHEVROLET', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(42, 'CHRYSLER', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(43, 'CITROEN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(44, 'CORVETTE', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(45, 'DAEWOO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(46, 'DAIDO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(47, 'DATSUN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(48, 'DEMAK', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(49, 'DFAC', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(50, 'DUCATI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(51, 'DYNO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(52, 'EICHER', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(53, 'FAW', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(54, 'FERRARI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(55, 'FIAT', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(56, 'FORCE', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(57, 'FOTON', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(58, 'HIGER', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(59, 'HILLMAN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(60, 'HINO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(61, 'HITACHI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(62, 'HUMMER', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(63, 'IHI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(64, 'IVECO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(65, 'JAC', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(66, 'JAGUAR', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(67, 'JCB', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(68, 'JEEP', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(69, 'JIALING', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(70, 'JMC', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(71, 'JOHN-DEERE', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(72, 'JONWAY', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(73, 'KAPLA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(74, 'KAWASAKI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(75, 'KINETIC', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(76, 'KMC', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(77, 'KOBELCO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(78, 'KOMATSU', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(79, 'KTM', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(80, 'KUBOTA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(81, 'LAMBORGHINI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(82, 'LAND-ROVER', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(83, 'LEXUS', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(84, 'LONCIN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(85, 'LONGJIA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(86, 'LOTUS', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(87, 'LTI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(88, 'MASERATI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(89, 'MASSEY-FERGUSON', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(90, 'METROCAB', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(91, 'MG', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(92, 'MG-ROVER', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(93, 'MINI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(94, 'MINNELLI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(95, 'MORGAN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(96, 'MORRIS', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(97, 'NEW-HOLLAND', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(98, 'NWOW', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(99, 'OPEL', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(100, 'OTHER', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(101, 'PIAGGIO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(102, 'PORSCHE', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(103, 'POWERTRAC', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(104, 'PROTON', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(105, 'RANGE-ROVER', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(106, 'RANOMOTO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(107, 'REVA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(108, 'ROLLS-ROYCE', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(109, 'SAAB', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(110, 'SAKAI', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(111, 'SEAT', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(112, 'SENARO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(113, 'SINGER', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(114, 'SKODA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(115, 'SMART', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(116, 'SONALIKA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(117, 'SUBARU', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(118, 'SWARAJ', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(119, 'SYUK', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(120, 'TAFE', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(121, 'TESLA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(122, 'TRIUMPH', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(123, 'VAUXHALL', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(124, 'VESPA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(125, 'VOLKSWAGEN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(126, 'VOLVO', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(127, 'WAVE', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(128, 'WILLYS', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(129, 'YADEA', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(130, 'YANMAR', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(131, 'YUEJIN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(132, 'ZONGSHEN', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0),
(133, 'ZOTYE', '2025-05-14 23:21:55', '2025-05-14 23:21:55', 0);
...
CREATE TABLE `vehicle_categories` (
  `vehicleCategoryId` int(10) UNSIGNED NOT NULL,
  `vehicleCategoryName` varchar(100) NOT NULL,
  `createdAt` datetime DEFAULT NULL,
  `updatedAt` datetime DEFAULT NULL,
  `isDeleted` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `vehicle_categories` (`vehicleCategoryId`, `vehicleCategoryName`, `createdAt`, `updatedAt`, `isDeleted`) VALUES
(1, 'CARS', '2025-03-26 09:04:12', '2025-03-26 23:53:25', 0),
(2, 'VAN', '2025-03-26 09:04:41', '2025-03-26 09:10:01', 0),
(3, 'THREE WHEELER', '2025-03-26 09:09:43', '2025-03-26 09:10:06', 0),
(4, 'LORRIES & TRUCKS', '2025-05-14 16:38:43', NULL, 0),
(5, 'HEAVY DUTY', '2025-05-14 16:39:04', NULL, 0),
(6, 'TRACTORS', '2025-05-14 16:39:15', NULL, 0),
(7, 'BUSES', '2025-05-14 16:39:27', NULL, 0),
(8, 'OTHERS', '2025-05-14 16:39:40', NULL, 0),
(9, 'SUV / JEEP', '2025-05-14 16:40:03', NULL, 0),
(10, 'CREW CAB', '2025-05-14 16:40:17', NULL, 0),
(11, 'PICKUP / DOUBLE CAB', '2025-05-14 16:40:38', NULL, 0),
(12, 'MOTORCYCLE', '2025-05-14 16:40:52', NULL, 0);
...
ALTER TABLE `accounts`
  ...
  ADD UNIQUE KEY `ux_accounts_slug` (`slug`);
...
ALTER TABLE `account_transactions`
  ...
  ADD KEY `idx_account_slug` (`account_slug`),
  ADD KEY `idx_reference` (`reference_type`,`reference_id`),
  ADD KEY `idx_created_at` (`created_at`),
  ADD KEY `idx_account_running_balance` (`account_slug`,`created_at`);
...
--
-- Indexes for table `employee_sections`
--
ALTER TABLE `employee_sections`
  ADD PRIMARY KEY (`employeeSectionId`);
...
ALTER TABLE `expenses_categories`
  ADD PRIMARY KEY (`expensesCategoryId`);
...
--
-- Indexes for table `internal_bills`
--
ALTER TABLE `internal_bills`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `internal_bill_items`
--
ALTER TABLE `internal_bill_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `internal_bill_id` (`internal_bill_id`),
...
--
-- Indexes for table `off_days_by_user`
--
ALTER TABLE `off_days_by_user`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_user_date` (`user_id`,`date`);

--
-- Indexes for table `outsource_parts`
--
ALTER TABLE `outsource_parts`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `purchase_history_items`
--
ALTER TABLE `purchase_history_items`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `purchase_history_payments`
--
ALTER TABLE `purchase_history_payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `history_id` (`history_id`),
  ADD KEY `po_id` (`po_id`),
...
--
-- Indexes for table `purchase_item_history`
--
ALTER TABLE `purchase_item_history`
...
ALTER TABLE `purchase_orders`
  ...
  ADD KEY `idx_supplier_bill_date` (`supplier_id`,`bill_date`),
  ADD KEY `idx_payment_status` (`payment_status`),
  ADD KEY `idx_total_paid` (`total_paid`);
...
--
-- Indexes for table `quick_bill`
--
ALTER TABLE `quick_bill`
  ADD PRIMARY KEY (`quick_bill_id`),
  ADD KEY `customer_id` (`customer_id`);

--
-- Indexes for table `quick_bill_deletions`
--
ALTER TABLE `quick_bill_deletions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `quick_bill_id` (`quick_bill_id`),
  ADD KEY `deleted_by` (`deleted_by`),
  ADD KEY `deleted_at` (`deleted_at`);

--
-- Indexes for table `quick_bill_items`
--
ALTER TABLE `quick_bill_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `service_job_id` (`quick_bill_id`),
  ADD KEY `item_id` (`item_id`);

--
-- Indexes for table `quick_bill_payments`
--
ALTER TABLE `quick_bill_payments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `quick_bill_return_items`
--
ALTER TABLE `quick_bill_return_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `return_request_id` (`return_request_id`),
  ADD KEY `quick_bill_item_id` (`quick_bill_item_id`),
  ADD KEY `item_id` (`item_id`);

--
-- Indexes for table `quick_bill_return_requests`
--
ALTER TABLE `quick_bill_return_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `quick_bill_id` (`quick_bill_id`),
  ADD KEY `created_by` (`created_by`),
...
--
-- Indexes for table `services_job`
--
ALTER TABLE `services_job`
  ADD PRIMARY KEY (`job_id`),
  ADD KEY `vehicle_id` (`vehicle_id`),
  ADD KEY `customer_id` (`customer_id`);

--
-- Indexes for table `services_job_items`
--
ALTER TABLE `services_job_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `service_job_id` (`service_job_id`),
  ADD KEY `item_id` (`item_id`);

--
-- Indexes for table `services_job_payments`
--
ALTER TABLE `services_job_payments`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `service_items_category`
--
...
ALTER TABLE `system_roles`
  ...
  ADD UNIQUE KEY `system_role_name` (`system_role_name`);
...
ALTER TABLE `vehicle_brands`
  ADD PRIMARY KEY (`vehicleBrandId`);
...
--
-- AUTO_INCREMENT for table `employee_sections`
--
ALTER TABLE `employee_sections`
  MODIFY `employeeSectionId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `expenses_categories`
  MODIFY `expensesCategoryId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- AUTO_INCREMENT for table `internal_bills`
--
ALTER TABLE `internal_bills`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `internal_bill_items`
--
ALTER TABLE `internal_bill_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `item_brands`
  MODIFY `itemBrandId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `item_categories`
--
ALTER TABLE `item_categories`
  MODIFY `itemCategoryId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
-- AUTO_INCREMENT for table `off_days_by_user`
--
ALTER TABLE `off_days_by_user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `outsource_parts`
--
ALTER TABLE `outsource_parts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `products`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=414;
...
--
-- AUTO_INCREMENT for table `purchase_history_items`
--
ALTER TABLE `purchase_history_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `purchase_history_payments`
--
ALTER TABLE `purchase_history_payments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `purchase_item_history`
--
ALTER TABLE `purchase_item_history`
...
--
ALTER TABLE `purchase_order_items`
  MODIFY `po_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `quick_bill`
--
ALTER TABLE `quick_bill`
  MODIFY `quick_bill_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `quick_bill_deletions`
--
ALTER TABLE `quick_bill_deletions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `quick_bill_items`
--
ALTER TABLE `quick_bill_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `quick_bill_payments`
--
ALTER TABLE `quick_bill_payments`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `quick_bill_return_items`
--
ALTER TABLE `quick_bill_return_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `quick_bill_return_requests`
--
ALTER TABLE `quick_bill_return_requests`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `services_job`
--
ALTER TABLE `services_job`
  MODIFY `job_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `services_job_items`
--
ALTER TABLE `services_job_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `services_job_payments`
--
ALTER TABLE `services_job_payments`
...
--
-- AUTO_INCREMENT for table `service_items_category`
--
ALTER TABLE `service_items_category`
  MODIFY `sic_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `suppliers`
  MODIFY `supplier_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `system_permissions`
--
ALTER TABLE `system_permissions`
  MODIFY `permission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1759;

--
-- AUTO_INCREMENT for table `system_roles`
--
ALTER TABLE `system_roles`
  MODIFY `system_role_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `vehicle_brands`
  MODIFY `vehicleBrandId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;

--
-- AUTO_INCREMENT for table `vehicle_categories`
--
ALTER TABLE `vehicle_categories`
  MODIFY `vehicleCategoryId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- Constraints for table `off_days_by_user`
--
ALTER TABLE `off_days_by_user`
  ADD CONSTRAINT `off_days_by_user_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`UserID`) ON DELETE CASCADE;
COMMIT;
